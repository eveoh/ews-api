...
public class TimeSpan implements Comparable, java.io.Serializable, Cloneable {
     ...
     * this object is less than, equal to, or greater than the specified object. Comparison is based on the number of
    ...
    /**
     * Indicates whether some other object is "equal to" this one. Comparison is based on the number of milliseconds in
     * this TimeSpan.
     *
     ...
     * provided by <code>java.util.Hashtable</code>. The method uses the same algorithm as found in the Long class.
     *
    ...
    /**
     * Returns a string representation of the object in the format. "[-]d.hh:mm:ss.ff" where "-" is an optional sign for
     * negative TimeSpan values, the "d" component is days, "hh" is hours, "mm" is minutes, "ss" is seconds, and "ff" is
     * milliseconds
     *
     ...
     * @return a negative integer, zero, or a positive integer as the first TimeSpan is less than, equal to, or greater
     *         than the second TimeSpan.
     */
