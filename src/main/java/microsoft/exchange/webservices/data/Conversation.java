...
/**
 * Represents a collection of Conversation related properties. Properties available on this object are defined in the
...
public class Conversation extends ServiceObject {
     ...
     */
    @Override
    protected void internalDelete(DeleteMode deleteMode, SendCancellationsMode sendCancellationsMode,
    ...
    /**
     * This method is not supported in this object. Gets a value indicating whether a time zone SOAP header should be
     * emitted in a CreateItem or UpdateItem request so this item can be property saved or updated.
     *
     ...
     */
    public void enableAlwaysCategorizeItems(Iterable<String> categories, boolean processSynchronously) throws
            ServiceResponseException, IndexOutOfBoundsException, Exception {

        ArrayList<ConversationId> convArry = new ArrayList<ConversationId>();
        convArry.add(this.getId());

        this.getService().enableAlwaysCategorizeItemsInConversations(convArry, categories, processSynchronously)
     ...
     *
     * @param processSynchronously Indicates whether the method should return only once disabling this rule and removing
     *                             the categories from existing items in the conversation is completely done. If
     *                             processSynchronously is false, the method returns immediately.
     * @throws Exception
     * @throws IndexOutOfBoundsException
     * @throws ServiceResponseException
     */
    public void disableAlwaysCategorizeItems(boolean processSynchronously) throws ServiceResponseException,
     ...
     *
     * @param processSynchronously Indicates whether the method should return only once enabling this rule and deleting
     *                             existing items in the conversation is completely done. If processSynchronously is
     *                             false,
     *                             the method returns immediately.
     * @throws Exception
     ...
     * @throws ServiceResponseException
     */
    public void enableAlwaysDeleteItems(boolean processSynchronously) throws ServiceResponseException,
            IndexOutOfBoundsException, Exception {
        ArrayList<ConversationId> convArry = new ArrayList<ConversationId>();
        convArry.add(this.getId());
        this.getService().enableAlwaysDeleteItemsInConversations(convArry, processSynchronously).getResponseAtIndex(0)
                .throwIfNecessary();
    }
     ...
     *                             restoring
     *                             the items in the conversation is completely done. If processSynchronously is
     *                             false, the
     ...
     * @throws ServiceResponseException
     */
    public void disableAlwaysDeleteItems(boolean processSynchronously) throws ServiceResponseException,
            IndexOutOfBoundsException, Exception {
        ArrayList<ConversationId> convArry = new ArrayList<ConversationId>();
        convArry.add(this.getId());
        this.getService().disableAlwaysDeleteItemsInConversations(convArry, processSynchronously).getResponseAtIndex(0)
                .throwIfNecessary();
    }
     ...
     * @param processSynchronously Indicates whether the method should return only once enabling this rule and moving
     *                             existing items in the conversation is completely done. If processSynchronously is
     *                             false,
     *                             the method returns immediately.
     * @throws Exception
     ...
     * @throws ServiceResponseException
     */
    public void enableAlwaysMoveItems(FolderId destinationFolderId, boolean processSynchronously) throws
            ServiceResponseException, IndexOutOfBoundsException, Exception {
        ArrayList<ConversationId> convArry = new ArrayList<ConversationId>();
        convArry.add(this.getId());
        this.getService().enableAlwaysMoveItemsInConversations(convArry, destinationFolderId, processSynchronously)
                .getResponseAtIndex(0).throwIfNecessary();
    }
     ...
     * @throws ServiceResponseException
     */
    public void disableAlwaysMoveItemsInConversation(boolean processSynchronously) throws ServiceResponseException,
            IndexOutOfBoundsException, Exception {
        ArrayList<ConversationId> convArry = new ArrayList<ConversationId>();
        convArry.add(this.getId());
        this.getService().disableAlwaysMoveItemsInConversations(convArry, processSynchronously).getResponseAtIndex(0)
                .throwIfNecessary();
    }
     ...
     *
     * @param contextFolderId The Id of the folder items must belong to in order to be deleted. If contextFolderId is
     *                        null,
     *                        items across the entire mailbox are deleted.
     * @param deleteMode      The deletion mode.
     * @throws Exception
     * @throws IndexOutOfBoundsException
     * @throws ServiceResponseException
     */
    public void deleteItems(FolderId contextFolderId, DeleteMode deleteMode) throws ServiceResponseException,
            IndexOutOfBoundsException, Exception {
        ...
        this.getService().deleteItemsInConversations(f, contextFolderId, deleteMode).getResponseAtIndex(0)
                .throwIfNecessary();
    }
     ...
     *
     * @param contextFolderId     The Id of the folder items must belong to in order to be moved. If contextFolderId is
     *                            null, items across the entire mailbox are moved.
     * @param destinationFolderId The Id of the destination folder.
     * @throws Exception
     * @throws IndexOutOfBoundsException
     * @throws ServiceResponseException
     */
    public void moveItemsInConversation(FolderId contextFolderId, FolderId destinationFolderId) throws
            ServiceResponseException, IndexOutOfBoundsException, Exception {
        HashMap<ConversationId, Date> m = new HashMap();
        m.put(this.getId(), this.getGlobalLastDeliveryTime());
     ...
     *
     * @param contextFolderId     The Id of the folder items must belong to in order to be copied. If contextFolderId is
     *                            null, items across the entire mailbox are copied.
     * @param destinationFolderId The Id of the destination folder.
     * @throws Exception
     * @throws IndexOutOfBoundsException
     * @throws ServiceResponseException
     */
    public void copyItemsInConversation(FolderId contextFolderId, FolderId destinationFolderId) throws
            ServiceResponseException, IndexOutOfBoundsException, Exception {
        HashMap<ConversationId, Date> m = new HashMap();
        m.put(this.getId(), this.getGlobalLastDeliveryTime());
     ...
     *
     * @param contextFolderId The Id of the folder items must belong to in order for their read state to be set. If
     *                        contextFolderId is null, the read states of items across the entire mailbox are set.
     * @param isRead          if set to <c>true</c>, conversation items are marked as read; otherwise they are marked as
     *                        unread.
     * @throws Exception
     * @throws IndexOutOfBoundsException
     * @throws ServiceResponseException
     */
    public void setReadStateForItemsInConversation(FolderId contextFolderId, boolean isRead) throws
            ServiceResponseException, IndexOutOfBoundsException, Exception {
        HashMap<ConversationId, Date> m = new HashMap();
        m.put(this.getId(), this.getGlobalLastDeliveryTime());
    ...
    /**
     * Gets a list of all the people who have sent messages that are currently unread in this conversation in the
     * current
     * folder only.
     *
    ...
    /**
     * Gets a list summarizing the categories stamped on messages in this conversation, across all folders in the
     * mailbox.
     *
     * @return returnValue
     * @throws ArgumentException
