...
public abstract class PropertyDefinition extends ServiceObjectPropertyDefinition {
     ...
     * @param version        The version.
     */
    protected PropertyDefinition(String xmlElementName, EnumSet<PropertyDefinitionFlags> flags,
     ...
     * @param version        The version.
     */
    protected PropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags,
                                 ExchangeVersion version) {
     ...
     *
     * @return A list of PropertyDefinition objects. This is a hack. It is here (currently) solely to help the API
     * register
     *         the MeetingTimeZone property definition that is internal.
     */
     ...
     */
    protected abstract void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws
            ServiceXmlDeserializationException, XMLStreamException, InstantiationException, IllegalAccessException,
     ...
     * @throws Exception                  the exception
     */
    protected abstract void writePropertyValueToXml(EwsServiceXmlWriter writer, PropertyBag propertyBag,
                                                    boolean isUpdateOperation) throws XMLStreamException,
