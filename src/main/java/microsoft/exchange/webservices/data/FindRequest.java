...
abstract class FindRequest<TResponse extends ServiceResponse> extends MultiResponseServiceRequest<TResponse> {
    ...
    protected void validate() throws ServiceLocalException, Exception {
        ...
        if (!(this.queryString == null || this.queryString.isEmpty()) &&
                this.getService().getRequestedServerVersion().ordinal() < ExchangeVersion.Exchange2010.ordinal()) {
            throw new ServiceVersionException(
                    String.format(Strings.ParameterIncompatibleWithRequestVersion, "queryString",
     ...
     * SearchFilter.ContainsSubstring and SearchFilter.SearchFilterCollection. If SearchFilter is null,
     * no search filters
     * are applied.
     *
