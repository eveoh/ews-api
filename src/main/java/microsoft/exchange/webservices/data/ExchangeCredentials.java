...
public abstract class ExchangeCredentials {
     ...
     * cref="Microsoft.Exchange.WebServices.Data.ExchangeCredentials"/>. This allows a NetworkCredential object to be
     * implictly converted to an ExchangeCredential which is useful when setting credentials on an ExchangeService.
     *
     ...
     */
    public static ExchangeCredentials getExchangeCredentialsFromNetworkCredential(String userName, String password,
                                                                                  String domain) {
     ...
     * WS-Security, or
     * for endpoints requiring WS-Addressing.
     *
     * @param writer        The writer.
