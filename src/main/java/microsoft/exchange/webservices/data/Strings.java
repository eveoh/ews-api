...
public abstract class Strings {
    ...
    static {
        ...
        try {
            BUNDLE.load(
                    Thread.currentThread().getContextClassLoader().getResource("EWSStrings.properties").openStream());
        }
        catch (Exception e) {
    ...
    private static void loadProperties() {
        BothSearchFilterAndQueryStringCannotBeSpecified =
                BUNDLE.getProperty("BothSearchFilterAndQueryStringCannotBeSpecified");
        //BothSearchFilterAndQueryStringCannotBeSpecified = rb.getString
        // ("BothSearchFilterAndQueryStringCannotBeSpecified");
        ...
        SearchFilterComparisonValueTypeIsNotSupported =
                BUNDLE.getProperty("SearchFilterComparisonValueTypeIsNotSupported");
        ServiceUrlMustBeSet = BUNDLE.getProperty("ServiceUrlMustBeSet");
        OperationNotSupportedForPropertyDefinitionType =
                BUNDLE.getProperty("OperationNotSupportedForPropertyDefinitionType");
        ...
        DayOfWeekIndexMustBeSpecifiedForRecurrencePattern =
                BUNDLE.getProperty("DayOfWeekIndexMustBeSpecifiedForRecurrencePattern");
        InvalidRecurrencePattern = BUNDLE.getProperty("InvalidRecurrencePattern");
        ItemIsOutOfDate = BUNDLE.getProperty("ItemIsOutOfDate");
        AutodiscoverInvalidSettingForOutlookProvider =
                BUNDLE.getProperty("AutodiscoverInvalidSettingForOutlookProvider");
        ...
        WLIDCredentialsCannotBeUsedWithLegacyAutodiscover =
                BUNDLE.getProperty("WLIDCredentialsCannotBeUsedWithLegacyAutodiscover");
        ...
        AutodiscoverServiceRequestRequiresDomainOrUrl =
                BUNDLE.getProperty("AutodiscoverServiceRequestRequiresDomainOrUrl");
        ...
        PropertyValueMustBeSpecifiedForRecurrencePattern =
                BUNDLE.getProperty("PropertyValueMustBeSpecifiedForRecurrencePattern");
        ...
        MergedFreeBusyIntervalMustBeSmallerThanTimeWindow =
                BUNDLE.getProperty("MergedFreeBusyIntervalMustBeSmallerThanTimeWindow");
        ...
        ContactGroupMemberCannotBeUpdatedWithoutBeingLoadedFirst =
                BUNDLE.getProperty("ContactGroupMemberCannotBeUpdatedWithoutBeingLoadedFirst");
        ...
        UpdateItemsDoesNotSupportNewOrUnchangedItems =
                BUNDLE.getProperty("UpdateItemsDoesNotSupportNewOrUnchangedItems");
        ...
        DayOfTheWeekMustBeSpecifiedForRecurrencePattern =
                BUNDLE.getProperty("DayOfTheWeekMustBeSpecifiedForRecurrencePattern");
        ServerVersionNotSupported = BUNDLE.getProperty("ServerVersionNotSupported");
        NewMessagesWithAttachmentsCannotBeSentDirectly =
                BUNDLE.getProperty("NewMessagesWithAttachmentsCannotBeSentDirectly");
        ...
        AutodiscoverServiceIncompatibleWithRequestVersion =
                BUNDLE.getProperty("AutodiscoverServiceIncompatibleWithRequestVersion");
        ...
        DayOfMonthMustBeSpecifiedForRecurrencePattern =
                BUNDLE.getProperty("DayOfMonthMustBeSpecifiedForRecurrencePattern");
