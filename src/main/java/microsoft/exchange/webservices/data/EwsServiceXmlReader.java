...
class EwsServiceXmlReader extends EwsXmlReader {
    ...
    /**
     * Reads the element value as date time, assuming it is unbiased (e.g. 2009/01/01T08:00) and scoped to service's
     * time
     * zone.
     *
     * @return Date
    ...
    public <TServiceObject extends ServiceObject> List<TServiceObject> readServiceObjectsCollectionFromXml(
            String collectionXmlElementName, IGetObjectInstanceDelegate<ServiceObject> getObjectInstanceDelegate,
            boolean clearPropertyBag, PropertySet requestedPropertySet, boolean summaryPropertiesOnly) throws
            Exception {
            ...
            do {
                ...
                if (this.isStartElement()) {
                    serviceObject = (TServiceObject) getObjectInstanceDelegate
                            .getObjectInstanceDelegate(this.getService(), this.getLocalName());
