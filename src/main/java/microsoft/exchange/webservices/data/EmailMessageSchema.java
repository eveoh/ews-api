...
public class EmailMessageSchema extends ItemSchema {
    ...
    public static final PropertyDefinition ToRecipients =
            new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class,
                    XmlElementNames.ToRecipients, FieldUris.ToRecipients,
                    ...
                    ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
                @Override
    ...
    public static final PropertyDefinition BccRecipients =
            new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class,
                    XmlElementNames.BccRecipients, FieldUris.BccRecipients,
                    EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet,
                            PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete),
                    ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
                @Override
    ...
    public static final PropertyDefinition CcRecipients =
            new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class,
                    XmlElementNames.CcRecipients, FieldUris.CcRecipients,
                    EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet,
                            PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete),
                    ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
                @Override
    ...
    public static final PropertyDefinition ConversationIndex =
            new ByteArrayPropertyDefinition(XmlElementNames.ConversationIndex, FieldUris.ConversationIndex,
    ...
    public static final PropertyDefinition From =
            new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.From, FieldUris.From,
    ...
    public static final PropertyDefinition IsDeliveryReceiptRequested =
            new BoolPropertyDefinition(XmlElementNames.IsDeliveryReceiptRequested, FieldUris.IsDeliveryReceiptRequested,
                    EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate,
                            PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind),
     ...
     */
    public static final PropertyDefinition IsRead = new BoolPropertyDefinition(XmlElementNames.IsRead, FieldUris.IsRead,
            EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate,
    ...
    public static final PropertyDefinition IsReadReceiptRequested =
            new BoolPropertyDefinition(XmlElementNames.IsReadReceiptRequested, FieldUris.IsReadReceiptRequested,
                    EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate,
                            PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind),
                    ExchangeVersion.Exchange2007_SP1);
    ...
    public static final PropertyDefinition InternetMessageId =
            new StringPropertyDefinition(XmlElementNames.InternetMessageId, FieldUris.InternetMessageId,
                    EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1);
    ...
    public static final PropertyDefinition References =
            new StringPropertyDefinition(XmlElementNames.References, FieldUris.References,
                    EnumSet.of(PropertyDefinitionFlags.CanSet, PropertyDefinitionFlags.CanUpdate,
                            PropertyDefinitionFlags.CanDelete, PropertyDefinitionFlags.CanFind),
                    ExchangeVersion.Exchange2007_SP1);
    ...
    public static final PropertyDefinition ReplyTo =
            new ComplexPropertyDefinition<EmailAddressCollection>(EmailAddressCollection.class, XmlElementNames.ReplyTo,
                    FieldUris.ReplyTo,
                    EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet,
                            PropertyDefinitionFlags.CanUpdate, PropertyDefinitionFlags.CanDelete),
                    ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddressCollection>() {
    ...
    public static final PropertyDefinition Sender =
            new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.Sender, FieldUris.Sender,
                    XmlElementNames.Mailbox,
    ...
    public static final PropertyDefinition ReceivedBy =
            new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.ReceivedBy,
                    FieldUris.ReceivedBy, XmlElementNames.Mailbox, EnumSet.of(PropertyDefinitionFlags.CanFind),
                    ExchangeVersion.Exchange2007_SP1, new ICreateComplexPropertyDelegate<EmailAddress>() {
                @Override
                public EmailAddress createComplexProperty() {
                    return new EmailAddress();
    ...
    public static final PropertyDefinition ReceivedRepresenting =
            new ContainedPropertyDefinition<EmailAddress>(EmailAddress.class, XmlElementNames.ReceivedRepresenting,
                    FieldUris.ReceivedRepresenting, XmlElementNames.Mailbox,
                    EnumSet.of(PropertyDefinitionFlags.CanFind), ExchangeVersion.Exchange2007_SP1,
    ...
    /**
     * Registers properties. IMPORTANT NOTE: PROPERTIES MUST BE REGISTERED IN SCHEMA ORDER (i.e. the same order as they are
     * defined in types.xsd)
     */
    @Override
