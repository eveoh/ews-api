...
public class Appointment extends Item implements ICalendarActionProvider {
    ...
    /**
     * Initializes an unsaved local instance of Appointment". To bind to an existing appointment, use Appointment.Bind()
     * instead.
     *
    ...
    /**
     * Binds to an existing appointment and loads the specified set of properties. Calling this method results in a
     * call to
     * EWS.
     *
    ...
    /**
     * Binds to an existing appointment and loads its first class properties. Calling this method results in a call to
     * EWS.
     *
     * @param service the service
     * @param id      the id
     ...
     * @throws Exception the exception
     */
    public static Appointment bindToOccurrence(ExchangeService service, ItemId recurringMasterId,
                                               int occurenceIndex) throws Exception {
        return Appointment
                .bindToOccurrence(service, recurringMasterId, occurenceIndex, PropertySet.FirstClassProperties);
    }
    ...
    public static Appointment bindToOccurrence(ExchangeService service, ItemId recurringMasterId, int occurenceIndex,
        ...
        AppointmentOccurrenceId occurenceId =
                new AppointmentOccurrenceId(recurringMasterId.getUniqueId(), occurenceIndex);
        return Appointment.bind(service, occurenceId, propertySet);
    }

    /**
     * Binds to the master appointment of a recurring series and loads its first class properties. Calling this method
    ...
    /**
     * Saves this appointment in the specified folder. Calling this method results in at least one call to EWS. Mutliple
     ...
     * @throws Exception the exception
     */
    public void save(WellKnownFolderName destinationFolderName, SendInvitationsMode sendInvitationsMode) throws
            Exception {
    ...
    /**
     * Saves this appointment in the Calendar folder. Calling this method results in at least one call to EWS. Mutliple
     * calls to EWS might be made if attachments have been added.
     *
     * @param sendInvitationsMode the send invitations mode
     * @throws Exception the exception
    ...
    /**
     * Applies the local changes that have been made to this appointment. Calling this method results in at least one
     * call
     * to EWS. Mutliple calls to EWS might be made if attachments have been added or removed.
     *
     ...
     * @return A CalendarActionResults object containing the various items that were created or modified as a results of
     *         this operation.
     * @throws Exception the exception
     */
    ...
    /**
     * Cancels the meeting and sends cancellation messages to all attendees. Calling this method results in a call to
     * EWS.
     *
     * @return A CalendarActionResults object containing the various items that were created or modified as a results of
     *         this operation.
    ...
    public LegacyFreeBusyStatus getLegacyFreeBusyStatus() throws ServiceLocalException {
        return (LegacyFreeBusyStatus) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.LegacyFreeBusyStatus);
    }
    ...
    public AppointmentType getAppointmentType() throws ServiceLocalException {
        return (AppointmentType) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.AppointmentType);
    }
    ...
    public MeetingResponseType getMyResponseType() throws ServiceLocalException {
        return (MeetingResponseType) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.MyResponseType);
    }

    /**
     * Gets the organizer of this meeting. The Organizer property is read-only and is only relevant for attendees. The
     * organizer of a meeting is automatically set to the user that created the meeting.
     *
    ...
    public AttendeeCollection getRequiredAttendees() throws ServiceLocalException {
        return (AttendeeCollection) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.RequiredAttendees);
    }
    ...
    public AttendeeCollection getOptionalAttendees() throws ServiceLocalException {
        return (AttendeeCollection) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.OptionalAttendees);
    }
    ...
    public Integer getConflictingMeetingCount() throws ServiceLocalException {
        return (Integer) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.ConflictingMeetingCount);
    }
    ...
    public ItemCollection<Appointment> getConflictingMeetings() throws ServiceLocalException {
        return (ItemCollection<Appointment>) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.ConflictingMeetings);
    }
    ...
    public Integer getAppointmentSequenceNumber() throws ServiceLocalException {
        return (Integer) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.AppointmentSequenceNumber);
    }
    ...
    public OccurrenceInfo getFirstOccurrence() throws ServiceLocalException {
        return (OccurrenceInfo) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.FirstOccurrence);
    }
    ...
    public OccurrenceInfoCollection getModifiedOccurrences() throws ServiceLocalException {
        return (OccurrenceInfoCollection) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.ModifiedOccurrences);
    }
    ...
    public DeletedOccurrenceInfoCollection getDeletedOccurrences() throws ServiceLocalException {
        return (DeletedOccurrenceInfoCollection) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.DeletedOccurrences);
    }
    ...
    public TimeZoneDefinition getStartTimeZone() throws ServiceLocalException {
        return (TimeZoneDefinition) this.getPropertyBag()
                .getObjectFromPropertyDefinition(AppointmentSchema.StartTimeZone);
    }
    ...
    /**
     * Gets  the URL of the meeting workspace. A meeting workspace is a shared Web site for planning meetings and
     * tracking
     * results.
     *
