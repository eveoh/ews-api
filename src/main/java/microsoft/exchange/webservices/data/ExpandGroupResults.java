...
public final class ExpandGroupResults implements Iterable<EmailAddress> {
    ...
    /**
     * Gets the number of members that were returned by the ExpandGroup operation. Count might be less than the total
     * number of members in the group, in which case the value of the IncludesAllMembers is false.
     *
     * @return the count
     */
    public int getCount() {
