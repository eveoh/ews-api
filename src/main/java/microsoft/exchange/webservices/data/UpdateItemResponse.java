...
public final class UpdateItemResponse extends ServiceResponse implements IGetObjectInstanceDelegate {
    ...
    protected void readElementsFromXml(EwsServiceXmlReader reader) throws ServiceXmlDeserializationException,
            XMLStreamException, InstantiationException, IllegalAccessException, Exception {
    ...
    /**
     * * Gets the item that was returned by the update operation. ReturnedItem is set only when a recurring Task is
     * marked
     * as complete or when its recurrence pattern changes.
     *
