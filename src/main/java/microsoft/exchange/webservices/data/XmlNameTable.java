...
public abstract class XmlNameTable {
     ...
     * @return The new atomized String or the existing one if it already exists. If length is zero, String.Empty is
     *         returned
     * @throws System.IndexOutOfRangeException
     *          0 > offset -or- offset >= array.Length -or- length > array.Length The above conditions do not cause an
     *          exception to be thrown if length =0.
    ...
    /**
     * When overridden in a derived class, gets the atomized String containing the same characters as the specified
     * range
     ...
     * @param offset Zero-based index into the array specifying the first character of the name.
     * @param length The number of characters in the name.
     * @return The atomized String or null if the String has not already been atomized. If length is zero,
     * String.Empty is
     *         returned
     * @throws System.IndexOutOfRangeException
     *          0 > offset -or- offset >= array.Length -or- length > array.Length The above conditions do not cause an
