...
public final class RuleCollection extends ComplexProperty implements Iterable<Rule> {
    ...
    /**
     * Gets a value indicating whether an Outlook rule blob exists in the user's mailbox. To update rules with EWS
     * when the
     * Outlook rule blob exists, call SetInboxRules passing true as the value of the removeOutlookBlob parameter.
     */
