...
public class Folder extends ServiceObject {
    ...
    /**
     * Binds to an existing folder, whatever its actual type is, and loads the specified set of properties. Calling this
     ...
     * @throws Exception the exception
     */
    public static Folder bind(ExchangeService service, WellKnownFolderName name, PropertySet propertySet) throws
            Exception {
        return Folder.bind(service, new FolderId(name), propertySet);
    }

    /**
     * * Binds to an existing folder, whatever its actual type is, and loads the specified set of properties. Calling
     * this
     * method results in a call to EWS.
     *
     * @param service The service to use to bind to the folder.
     ...
     * @return A new folder representing this folder in its new location. After Move completes, this folder does not
     * exist
     *         anymore.
     * @throws Exception the exception
     */
     ...
     * @return A new folder representing this folder in its new location. After Move completes,
     ...
     * @throws Exception the exception
     */
    <TItem extends Item> ServiceResponseCollection<FindItemResponse<TItem>> internalFindItems(String queryString,
                                                                                              ViewBase view,
     ...
     * @throws Exception the exception
     */
    <TItem extends Item> ServiceResponseCollection<FindItemResponse<TItem>> internalFindItems(SearchFilter searchFilter,
                                                                                              ViewBase view,
                                                                                              Grouping groupBy) throws
            Exception {
        ArrayList<FolderId> folderIdArry = new ArrayList<FolderId>();
    ...
    public FindItemsResults<Item> findItems(SearchFilter searchFilter, ItemView view) throws Exception {
        ...
        ServiceResponseCollection<FindItemResponse<Item>> responses =
                this.internalFindItems(searchFilter, view, null /* groupBy */);
    ...
    public FindItemsResults<Item> findItems(String queryString, ItemView view) throws Exception {
        ...
        ServiceResponseCollection<FindItemResponse<Item>> responses =
                this.internalFindItems(queryString, view, null /* groupBy */);
    ...
    public FindItemsResults<Item> findItems(ItemView view) throws Exception {
        ServiceResponseCollection<FindItemResponse<Item>> responses =
                this.internalFindItems((SearchFilter) null, view, null /* groupBy */);
     ...
     * @throws Exception the exception
     */
    public GroupedFindItemsResults<Item> findItems(SearchFilter searchFilter, ItemView view, Grouping groupBy) throws
            Exception {
        EwsUtilities.validateParam(groupBy, "groupBy");
        EwsUtilities.validateParamAllowNull(searchFilter, "searchFilter");

        ServiceResponseCollection<FindItemResponse<Item>> responses =
                this.internalFindItems(searchFilter, view, groupBy);
     ...
     * @throws Exception the exception
     */
    public GroupedFindItemsResults<Item> findItems(String queryString, ItemView view, Grouping groupBy) throws
            Exception {
        EwsUtilities.validateParam(groupBy, "groupBy");

        ServiceResponseCollection<FindItemResponse<Item>> responses =
                this.internalFindItems(queryString, view, groupBy);
    ...
    /**
     * Obtains a grouped list of items by searching the contents of this folder. Calling this method results in a
     * call to
     * EWS.
     *
     * @param view    The view controlling the number of folders returned.
    ...
    public int getChildFolderCount() throws NumberFormatException, ServiceLocalException {
        return (Integer.parseInt(
                this.getPropertyBag().getObjectFromPropertyDefinition(FolderSchema.ChildFolderCount).toString()));
    }
    ...
    public int getTotalCount() throws NumberFormatException, ServiceLocalException {
        return (Integer
                .parseInt(this.getPropertyBag().getObjectFromPropertyDefinition(FolderSchema.TotalCount).toString()));
    }
    ...
    public ManagedFolderInformation getManagedFolderInformation() throws ServiceLocalException {
        return (ManagedFolderInformation) this.getPropertyBag()
                .getObjectFromPropertyDefinition(FolderSchema.ManagedFolderInformation);
    }
    ...
    public int getUnreadCount() throws NumberFormatException, ServiceLocalException {
        return (Integer
                .parseInt(this.getPropertyBag().getObjectFromPropertyDefinition(FolderSchema.UnreadCount).toString()));
    }
