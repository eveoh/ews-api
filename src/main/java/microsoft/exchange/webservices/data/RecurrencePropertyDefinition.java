...
public class RecurrencePropertyDefinition extends PropertyDefinition {
     ...
     */
    protected RecurrencePropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags,
    ...
    protected void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws Exception {
        ...
        if (reader.getLocalName().equals(XmlElementNames.RelativeYearlyRecurrence)) {
            ...
            throw new ServiceXmlDeserializationException(
                    String.format(Strings.InvalidRecurrencePattern, reader.getLocalName()));
        }
        ...
        if (reader.getLocalName().equals(XmlElementNames.NoEndRecurrence)) {
            ...
            throw new ServiceXmlDeserializationException(
                    String.format(Strings.InvalidRecurrenceRange, reader.getLocalName()));
        }
     ...
     * @throws Exception the exception
     */
    protected void writePropertyValueToXml(EwsServiceXmlWriter writer, PropertyBag propertyBag,
