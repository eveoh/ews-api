...
abstract class HangingServiceRequestBase extends ServiceRequestBase {
    ...
    /**
     * Test switch to log all bytes that come across the wire. Helpful when parsing fails before certain bytes hit the
     * trace logs.
     */
     ...
     */
    protected HangingServiceRequestBase(ExchangeService service, IHandleResponseObject handler,
                                        int heartbeatFrequency) throws ServiceVersionException {
        super(service);
    ...
    private void parseResponses(Object state) {
        ...
        try {
            ...
            //EwsServiceMultiResponseXmlReader ewsXmlReader = EwsServiceMultiResponseXmlReader.create(tracingStream,
            // getService());
