...
public final class MimeContent extends ComplexProperty {
     ...
     */
    @Override
    protected void readTextValueFromXml(EwsServiceXmlReader reader) throws XMLStreamException,
    ...
    public String toString() {
        if (this.getContent() == null) {
            ...
            try {
                ...
                String charSet = (this.getCharacterSet() == null || this.getCharacterSet().isEmpty()) ? "UTF-8" :
