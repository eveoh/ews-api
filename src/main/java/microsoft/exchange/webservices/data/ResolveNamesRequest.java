...
final class ResolveNamesRequest extends MultiResponseServiceRequest<ResolveNamesResponse> {
     ...
     */
    private static LazyMember<Map<ResolveNameSearchLocation, String>> searchScopeMap =
    ...
    protected void writeAttributesToXml(EwsServiceXmlWriter writer) throws ServiceXmlSerializationException {
        ...
        EwsUtilities
                .EwsAssert((!(searchScope == null || searchScope.isEmpty())), "ResolveNameRequest.WriteAttributesToXml",
        ...
        if (this.getContactDataPropertySet() != null) {
            //((PropertyBag)PropertySet.getDefaultPropertySetDictionary( ).getMember()).tryGetValue(this
            // .contactDataPropertySet.getBasePropertySet(),  propertySet);
    ...
    /**
     * Gets a value indicating whether to return full contact data or not. <value> <c>true</c> if should return full
     * contact data; otherwise, <c>false</c>. </value>
     *
