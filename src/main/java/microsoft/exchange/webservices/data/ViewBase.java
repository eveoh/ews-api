...
public abstract class ViewBase {
     ...
     */
    protected void internalValidate(ServiceRequestBase request) throws ServiceValidationException,
     ...
     */
    protected void internalWriteViewToXml(EwsServiceXmlWriter writer) throws ServiceXmlSerializationException,
            Exception {
     ...
     *                            the service xml serialization exception
     */
    protected abstract void internalWriteSearchSettingsToXml(EwsServiceXmlWriter writer, Grouping groupBy) throws
     ...
     *                            the service xml serialization exception
     */
    protected abstract void writeOrderByToXml(EwsServiceXmlWriter writer) throws XMLStreamException,
    ...
    /**
     * Gets the property set. PropertySet determines which properties will be loaded on found items. If PropertySet is
     * null, all first class properties are loaded on found items.
     *
    ...
    /**
     * Sets the property set. PropertySet determines which properties will be loaded on found items. If PropertySet is
     * null, all first class properties are loaded on found items.
     *
