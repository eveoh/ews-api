    ...
    protected void loadDomainSettingsFromXml(EwsXmlReader reader) throws Exception {
        if (!reader.isEmptyElement()) {
            do {
                ...
                if ((reader.getNodeType().nodeType == XMLNodeType.START_ELEMENT) &&
                        (reader.getLocalName().equals(XmlElementNames.DomainSetting))) {
                    String settingClass =
                            reader.readAttributeValue(XmlNamespace.XmlSchemaInstance, XmlAttributeNames.Type);
                    ...
                    if (settingClass.equals(XmlElementNames.DomainStringSetting)) {
                        ...
                        EwsUtilities.EwsAssert(false, "GetDomainSettingsResponse." + "LoadDomainSettingsFromXml",
    ...
    private void loadDomainSettingErrorsFromXml(EwsXmlReader reader) throws Exception {
        if (!reader.isEmptyElement()) {
            do {
                ...
                if ((reader.getNodeType().nodeType == XMLNodeType.START_ELEMENT) &&
                        (reader.getLocalName().equals(XmlElementNames.DomainSettingError))) {
