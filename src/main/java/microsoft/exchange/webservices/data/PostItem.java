...
public final class PostItem extends Item {
    ...
    /**
     * Binds to an existing post item and loads the specified set of properties. Calling this method results in a
     * call to
     * EWS.
     *
     * @param service     the service
    ...
    /**
     * Binds to an existing post item and loads its first class properties. calling this method results in a call to
     * EWS.
     *
     * @param service the service
     * @param id      the id
     ...
     * @return A ResponseMessage representing the e-mail reply response that can subsequently be modified and sent.
     * @throws Exception the exception
     */
