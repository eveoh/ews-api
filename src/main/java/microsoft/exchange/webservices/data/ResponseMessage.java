...
public final class ResponseMessage extends ResponseObject<EmailMessage> {
     ...
     *         associated with this type is determined by the EwsObjectDefinition attribute that decorates the type,if
     *         present.
     */
    ...
    /**
     * * Gets the body prefix of this response. The body prefix will be prepended to the original message's body when
     * the
     * response is created.
     *
