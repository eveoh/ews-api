...
public class CalendarFolder extends Folder {
    ...
    /**
     * Binds to an existing calendar folder and loads the specified set of properties. Calling this method results in a
     * call to EWS.
     *
     ...
     * @throws Exception the exception
     */
    public static CalendarFolder bind(ExchangeService service, WellKnownFolderName name, PropertySet propertySet) throws
            Exception {
    ...
    /**
     * Obtains a list of appointments by searching the contents of this folder and performing recurrence expansion for
     * recurring appointments. Calling this method results in a call to EWS.
     *
     * @param view the view
