...
/**
 * * Represents an abstract Move/Copy Item request. <typeparam name="TResponse">The type of the response.</typeparam>
 *
...
public abstract class MoveCopyItemRequest<TResponse extends ServiceResponse> extends MoveCopyRequest<Item, TResponse> {
    ...
    protected void writeIdsToXml(EwsServiceXmlWriter writer) throws Exception {
        ...
        if (this.getReturnNewItemIds() != null) {
            writer.writeElementValue(XmlNamespace.Messages, XmlElementNames.ReturnNewItemIds,
