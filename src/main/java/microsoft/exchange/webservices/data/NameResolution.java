...
public final class NameResolution {
    ...
    protected void loadFromXml(EwsServiceXmlReader reader) throws Exception {
        ...
        if (reader.isStartElement(XmlNamespace.Types, XmlElementNames.Contact)) {
            ...
            this.contact.loadFromXml(reader, true /* clearPropertyBag */, PropertySet.FirstClassProperties,
    ...
    /**
     * Gets the contact information of the suggested resolved name. This property is only available when ResolveName is
     * called with returnContactDetails = true.
     *
     * @return the contact
     */
