...
public class MeetingMessage extends EmailMessage {
    ...
    /**
     * Binds to an existing meeting message and loads the specified set of properties. Calling this method results in a
     * call to EWS.
     *
    ...
    /**
     * Binds to an existing meeting message and loads its first class properties. Calling this method results in a
     * call to
     * EWS.
     *
     * @param service The service to use to bind to the meeting message.
