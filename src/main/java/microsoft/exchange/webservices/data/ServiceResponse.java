...
public class ServiceResponse {
    ...
    protected void loadFromXml(EwsServiceXmlReader reader, String xmlElementName) throws Exception {
        ...
        if (this.result == ServiceResult.Success || this.result == ServiceResult.Warning) {
            ...
            this.errorCode =
                    reader.readElementValue(ServiceError.class, XmlNamespace.Messages, XmlElementNames.ResponseCode);
            ...
            if (reader.isStartElement()) {
                if (reader.getLocalName().equals(XmlElementNames.Value)) {
                    ...
                    this.errorProperties
                            .add(ServiceObjectSchema.findPropertyDefinition(reader.readAttributeValue(XmlAttributeNames.
                                    FieldURI)));
                }
     ...
     * @throws Exception              the exception
     */
    protected void readElementsFromXml(EwsServiceXmlReader reader) throws ServiceXmlDeserializationException,
            XMLStreamException, InstantiationException, IllegalAccessException, ServiceLocalException, Exception {
    }
     ...
     * @return True if the expected extra details is loaded; False if the element name does not match the expected
     *         element.
     */
    ...
    /**
     * * Gets a detailed error message associated with the response. If Result is set to Success, ErrorMessage returns
     * null. ErrorMessage is localized according to the PreferredCulture property of the ExchangeService object that was
     * used to call the method that generated the response.
     *
     ...
     * ErrorDetailsDictionary returns null.
     ...
     * ErrorProperties
     * returns null. ErrorProperties is only available for some error codes. For example, when the error code is
     * ErrorInvalidPropertyForOperation, ErrorProperties will contain the definition of the property that was invalid for
     * the request.
     *
