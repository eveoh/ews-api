...
/**
 * * Represents the base response class for synchronuization operations. <typeparam name="TServiceObject">ServiceObject
 * type.</typeparam> <typeparam name="TChange">Change type.</typeparam>
 *
...
public abstract class SyncResponse<TServiceObject extends ServiceObject, TChange extends Change>
    ...
    protected void readElementsFromXml(EwsServiceXmlReader reader) throws ServiceLocalException, Exception {
        ...
        this.changes.setMoreChangesAvailable(!reader.readElementValue(Boolean.class, XmlNamespace.Messages,
                    ...
                    if (change != null) {
                        ...
                        if (change.getChangeType().equals(ChangeType.Delete) ||
                            ...
                            if (change.getChangeType().equals(ChangeType.ReadFlagChange)) {
                                ...
                                EwsUtilities.EwsAssert(itemChange != null, "SyncResponse." + "ReadElementsFromXml",
                                        "ReadFlagChange is only " + "valid on ItemChange");

                                itemChange.setIsRead(reader.readElementValue(Boolean.class, XmlNamespace.Types,
                            ...
                            change.setServiceObject(EwsUtilities
                                    .createEwsObjectFromXmlElementName(null, reader.getService(),
                                            reader.getLocalName()));
