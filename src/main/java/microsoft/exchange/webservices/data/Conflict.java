...
public final class Conflict extends ComplexProperty {
    ...
    /**
     * Gets the number of users, resources, and rooms in the conflicting group. The value of this property is only
    ...
    /**
     * Gets the number of members who are available (whose status is Free) in the conflicting group. The value of this
     ...
     * The value of this property is only meaningful when ConflictType is equal to ConflictType.GroupConflict.
     *
    ...
    /**
     * Gets the number of members who do not have published free/busy data in the conflicting group. The value of this
     * property is only meaningful when ConflictType is equal to ConflictType.GroupConflict.
     *
