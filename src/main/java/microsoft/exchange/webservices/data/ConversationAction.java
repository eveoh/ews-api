    ...
    protected void writeElementsToXml(EwsServiceXmlWriter writer) throws Exception {
        ...
        try {
            ...
            if (this.getAction() == ConversationActionType.AlwaysCategorize ||
                ...
                writer.writeElementValue(XmlNamespace.Types, XmlElementNames.ProcessRightAway,
            ...
            if (this.getAction() == ConversationActionType.AlwaysCategorize) {
                ...
                writer.writeElementValue(XmlNamespace.Types, XmlElementNames.EnableAlwaysDelete,
                ...
                if (this.getConversationLastSyncTime() != null) {
                    writer.writeElementValue(XmlNamespace.Types, XmlElementNames.ConversationLastSyncTime,
                            this.getConversationLastSyncTime());
                }

                if (this.getAction() == ConversationActionType.Copy) {
                    EwsUtilities.EwsAssert(this.getDestinationFolderId() != null, "ApplyconversationActionRequest",
                    ...
                    EwsUtilities.EwsAssert(this.getDeleteType() != null, "ApplyconversationActionRequest",
                    ...
                    EwsUtilities.EwsAssert(this.getIsRead() != null, "ApplyconversationActionRequest",
