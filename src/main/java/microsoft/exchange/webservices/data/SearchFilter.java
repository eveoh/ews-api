...
public abstract class SearchFilter extends ComplexProperty {
    ...
    /**
     * Represents a search filter that checks for the presence of a substring inside a text property. Applications
     * can use
     * ContainsSubstring to define conditions such as "Field CONTAINS Value" or "Field IS PREFIXED WITH Value".
     */
    public static final class ContainsSubstring extends PropertyBasedFilter {
         ...
         */
        public ContainsSubstring(PropertyDefinitionBase propertyDefinition, String value,
                                 ContainmentMode containmentMode, ComparisonMode comparisonMode) {
        ...
        protected void readAttributesFromXml(EwsServiceXmlReader reader) throws Exception {
            ...
            try {
                this.comparisonMode =
                        reader.readAttributeValue(ComparisonMode.class, XmlAttributeNames.ContainmentComparison);
            }
    ...
    /**
     * Represents a search filter checking if a field is set. Applications can use ExistsFilter to define conditions
     * such
     * as "Field IS SET".
     */
    ...
    public static class IsGreaterThanOrEqualTo extends RelationalFilter {
         ...
         * @param otherPropertyDefinition The definition of the property to compare with.
         */
        public IsGreaterThanOrEqualTo(PropertyDefinitionBase propertyDefinition,
                                      PropertyDefinitionBase otherPropertyDefinition) {
            super(propertyDefinition, otherPropertyDefinition);
        }
    ...
    /**
     * Represents a search filter that negates another. Applications can use NotFilter to define conditions such as
     * "NOT(other filter)".
     */
            ...
            if (this.otherPropertyDefinition == null && this.value == null) {
                ...
                if (!((value instanceof Object) || (value instanceof ISearchStringProvider))) {
                    throw new ServiceValidationException(
                            String.format(Strings.SearchFilterComparisonValueTypeIsNotSupported,
     ...
     * to define complex search filters such as "Condition1 AND Condition2".
     */
    public static class SearchFilterCollection extends SearchFilter
            implements Iterable<SearchFilter>, IComplexPropertyChangedDelegate {
         ...
         *
         * @param searchFilter >The search filter to add. Available search filter classes include SearchFilter.IsEqualTo,
         *                     SearchFilter.ContainsSubstring and SearchFilter.SearchFilterCollection.
         */
         ...
         *
         * @param searchFilters The search filters to add. Available search filter classes include SearchFilter.IsEqualTo,
         *                      SearchFilter.ContainsSubstring and SearchFilter.SearchFilterCollection
         */
