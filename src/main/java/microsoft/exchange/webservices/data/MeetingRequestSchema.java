...
public class MeetingRequestSchema extends MeetingMessageSchema {
    ...
    public static final PropertyDefinition MeetingRequestType =
            new GenericPropertyDefinition<MeetingRequestType>(MeetingRequestType.class,
                    XmlElementNames.MeetingRequestType, FieldUris.MeetingRequestType, ExchangeVersion.Exchange2007_SP1);
