...
public class EmailAddress extends ComplexProperty implements ISearchStringProvider {
    ...
    /**
     * Sets the actual address associated with the e-mail address. The type of the Address property must match the
     * specified routing type. If RoutingType is not set, Address is assumed to be an SMTP address.
     *
    ...
    /**
     * Sets the routing type associated with the e-mail address. If RoutingType is not set, Address is assumed to be an
     * SMTP address.
     *
