...
class DateTimePropertyDefinition extends PropertyDefinition {
     ...
     * @param version        the version
     */
    protected DateTimePropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags,
    ...
    protected void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws Exception {
        ...
        propertyBag
                .setObjectFromPropertyDefinition(this, reader.getService().convertUniversalDateTimeStringToDate(value));
    }
