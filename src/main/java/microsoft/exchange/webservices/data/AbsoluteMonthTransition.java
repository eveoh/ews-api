...
abstract class AbsoluteMonthTransition extends TimeZoneTransition {
    ...
    protected boolean tryReadElementFromXml(EwsServiceXmlReader reader) throws Exception {
        if (super.tryReadElementFromXml(reader)) {
            ...
            if (reader.getLocalName().equals(XmlElementNames.TimeOffset)) {
                ...
                EwsUtilities
                        .EwsAssert(this.month > 0 && this.month <= 12, "AbsoluteMonthTransition.TryReadElementFromXml",
    ...
    protected void writeElementsToXml(EwsServiceXmlWriter writer) throws ServiceXmlSerializationException,
        ...
        writer.writeElementValue(XmlNamespace.Types, XmlElementNames.TimeOffset,
