...
final class OutlookConfigurationSettings extends ConfigurationSettingsBase {
     ...
     */
    @Override
    protected boolean tryReadCurrentXmlElement(EwsXmlReader reader) throws ServiceXmlDeserializationException,
    ...
    private void reportUnsupportedSettings(List<UserSettingName> requestedSettings, GetUserSettingsResponse response) {
        ...
        for (UserSettingName invalidSetting : invalidSettingQuery) {
            ...
            settingError.setErrorMessage(
                    String.format(Strings.AutodiscoverInvalidSettingForOutlookProvider, invalidSetting.toString()));
