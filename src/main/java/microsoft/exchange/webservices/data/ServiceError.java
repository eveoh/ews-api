...
public enum ServiceError {
     ...
     * Ensure
     * that the RequestServerVersion SOAP header is set with the correct RequestServerVersionValue.
     */
    ErrorIncorrectSchemaVersion,
    ...
    /**
     * One or more UserId parameters are invalid. Make sure that the PrimarySmtpAddress, Sid and DisplayName properties
     * refer to the same user when specified.
     */
     ...
     * Please
     * use the ConvertId method to convert from EwsLegacyId to EwsId format.
     */
    ...
    /**
     * The mailbox of the authenticating user and the mailbox of the resource being accessed must have the same Mailbox
     * server version.
     */
    ErrorWrongServerVersionDelegate,
