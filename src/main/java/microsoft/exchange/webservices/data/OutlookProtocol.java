...
final class OutlookProtocol {
    ...
    /**
     * Converters to translate common Outlook protocol settings. Each entry maps to a lambda expression used to get the
     * matching property from the OutlookProtocol instance.
     */
    private static LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>> commonProtocolSettings =
    ...
    /**
     * Converters to translate internal (EXCH) Outlook protocol settings. Each entry maps to a lambda expression used to
     * get the matching property from the OutlookProtocol instance.
     */
    private static LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>> internalProtocolSettings =
            new LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>(
                    new ILazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>() {
                        public Map<UserSettingName, IFunc<OutlookProtocol, Object>> createInstance() {
                            ...
                            results.put(UserSettingName.InternalEwsUrl, new IFunc<OutlookProtocol, Object>() {
                                public Object func(OutlookProtocol arg) {
                                    return arg.exchangeWebServicesUrl == null ? arg.availabilityServiceUrl :
                                            arg.exchangeWebServicesUrl;
                                }
                            });
    ...
    /**
     * Converters to translate external (EXPR) Outlook protocol settings. Each entry maps to a lambda expression used to
     * get the matching property from the OutlookProtocol instance.
     */
    private static LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>> externalProtocolSettings =
            new LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>(
                    new ILazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>() {
                        public Map<UserSettingName, IFunc<OutlookProtocol, Object>> createInstance() {
                            ...
                            results.put(UserSettingName.ExternalMailboxServerAuthenticationMethods,
                                    new IFunc<OutlookProtocol, Object>() {
                                        public Object func(OutlookProtocol arg) {
                                            return arg.authPackage;
                                        }
                                    });
                            results.put(UserSettingName.ExternalMailboxServerRequiresSSL,
                                    new IFunc<OutlookProtocol, Object>() {
                                        public Object func(OutlookProtocol arg) {
    ...
    /**
     * Merged converter dictionary for translating internal (EXCH) Outlook protocol settings. Each entry maps to a
     * lambda
    ...
    private static LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>
            internalProtocolConverterDictionary = new LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>(
            new ILazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>() {
                public Map<UserSettingName, IFunc<OutlookProtocol, Object>> createInstance() {

                    Map<UserSettingName, IFunc<OutlookProtocol, Object>> results =
                            new HashMap<UserSettingName, IFunc<OutlookProtocol, Object>>();
                    for (Entry<UserSettingName, IFunc<OutlookProtocol, Object>> kv : commonProtocolSettings.getMember()
                            .entrySet()) {
    ...
    /**
     * Merged converter dictionary for translating external (EXPR) Outlook protocol settings. Each entry maps to a
     * lambda
     * expression used to get the matching property from the OutlookProtocol instance.
     */
    private static LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>
            externalProtocolConverterDictionary = new LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>(
            new ILazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>() {
                public Map<UserSettingName, IFunc<OutlookProtocol, Object>> createInstance() {
    ...
    /**
     * Converters to translate Web (WEB) Outlook protocol settings. Each entry maps to a lambda expression used to
     * get the
     * matching property from the OutlookProtocol instance.
     */
    private static LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>> webProtocolConverterDictionary =
            new LazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>(
                    new ILazyMember<Map<UserSettingName, IFunc<OutlookProtocol, Object>>>() {
                        public Map<UserSettingName, IFunc<OutlookProtocol, Object>> createInstance() {
     ...
     */
    private static LazyMember<List<UserSettingName>> availableUserSettings =
            new LazyMember<List<UserSettingName>>(new ILazyMember<List<UserSettingName>>() {
     ...
     */
    private static LazyMember<Map<String, OutlookProtocolType>> protocolNameToTypeMap =
            new LazyMember<Map<String, OutlookProtocolType>>(new ILazyMember<Map<String, OutlookProtocolType>>() {
                @Override
        ...
        do {
            ...
            if (reader.getNodeType().getNodeType() == XMLNodeType.START_ELEMENT) {
                if (reader.getLocalName().equals(XmlElementNames.Type)) {
                    ...
                    OutlookProtocol
                            .loadWebClientUrlsFromXml(reader, this.internalOutlookWebAccessUrls, reader.getLocalName());
                }
                else if (reader.getLocalName().equals(XmlElementNames.External)) {
                    OutlookProtocol
                            .loadWebClientUrlsFromXml(reader, this.externalOutlookWebAccessUrls, reader.getLocalName());
                }
     ...
     * @throws Exception
     */
    private static void loadWebClientUrlsFromXml(EwsXmlReader reader, WebClientUrlCollection webClientUrls,
    ...
    private String convertEcpFragmentToUrl(String fragment) {
        return ((this.ecpUrl == null || this.ecpUrl.isEmpty()) || (fragment == null || fragment.isEmpty())) ? null :
