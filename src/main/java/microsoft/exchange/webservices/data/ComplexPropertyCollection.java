...
public abstract class ComplexPropertyCollection<TComplexProperty extends ComplexProperty> extends ComplexProperty
        implements ICustomXmlUpdateSerializer, Iterable<TComplexProperty>, IComplexPropertyChangedDelegate {
    ...
    protected void itemChanged(ComplexProperty complexProperty) {
        EwsUtilities.EwsAssert(complexProperty instanceof ComplexProperty, "ComplexPropertyCollection.ItemChanged",
     ...
     */
    @Override
    protected void loadFromXml(EwsServiceXmlReader reader, XmlNamespace xmlNamespace, String localElementName) throws
            Exception {
    ...
    protected void updateFromXml(EwsServiceXmlReader reader, XmlNamespace xmlNamespace, String xmlElementName) throws
            Exception {
    ...
    private void internalAdd(TComplexProperty complexProperty, boolean loading) {
        EwsUtilities
                .EwsAssert(complexProperty != null, "ComplexPropertyCollection.InternalAdd", "complexProperty is null");
    ...
    protected void internalRemoveAt(int index) {
        EwsUtilities.EwsAssert(index >= 0 && index < this.getCount(), "ComplexPropertyCollection.InternalRemoveAt",
     ...
     */
    @Override
    public boolean writeSetUpdateToXml(EwsServiceXmlWriter writer, ServiceObject ewsObject,
