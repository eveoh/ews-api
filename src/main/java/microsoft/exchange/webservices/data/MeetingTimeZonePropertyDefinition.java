...
class MeetingTimeZonePropertyDefinition extends PropertyDefinition {
     ...
     */
    protected MeetingTimeZonePropertyDefinition(String xmlElementName, String uri,
     ...
     */
    protected final void loadPropertyValueFromXml(EwsServiceXmlReader reader, PropertyBag propertyBag) throws
            Exception {
