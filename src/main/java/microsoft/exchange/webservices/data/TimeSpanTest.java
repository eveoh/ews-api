...
public class TimeSpanTest {
    ...
    public static String timeSpanToXSDuration(Calendar timeSpan) {
        ...
        String obj = String.format("%s %s %s %s %s ", offsetStr, Math.abs(timeSpan.DAY_OF_MONTH),
                Math.abs(timeSpan.HOUR_OF_DAY), Math.abs(timeSpan.MINUTE), Math.abs(timeSpan.SECOND) + "." +
