 ...
 */
public final class PhysicalAddressEntry extends DictionaryEntryProperty<PhysicalAddressKey>
     ...
     */
    @Override
    protected boolean writeSetUpdateToXml(EwsServiceXmlWriter writer, ServiceObject ewsObject,
                                          String ownerDictionaryXmlElementName) throws XMLStreamException,
            ServiceXmlSerializationException {
     ...
     */
    @Override
    protected boolean writeDeleteUpdateToXml(EwsServiceXmlWriter writer, ServiceObject ewsObject) throws
     ...
     *                            the service xml serialization exception
     */
    private void internalWriteDeleteFieldToXml(EwsServiceXmlWriter writer, ServiceObject ewsObject,
                                               String fieldXmlElementName) throws XMLStreamException,
            ServiceXmlSerializationException {
