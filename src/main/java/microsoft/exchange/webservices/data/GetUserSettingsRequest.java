...
class GetUserSettingsRequest extends AutodiscoverRequest {
     ...
     * @throws ServiceValidationException
     */
    protected GetUserSettingsRequest(AutodiscoverService service, URI url, boolean expectPartnerToken) throws
    ...
    protected void writeExtraCustomSoapHeadersToXml(EwsServiceXmlWriter writer) throws XMLStreamException,
        ...
        if (this.expectPartnerToken) {
            writer.writeElementValue(XmlNamespace.Autodiscover, XmlElementNames.BinarySecret,
                    Convert.ToBase64String(ExchangeServiceBase.getSessionKey()));
        }
    }
