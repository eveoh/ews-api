...
class EwsServiceXmlWriter implements IDisposable {
     ...
     * @param str   the str
     * @return True if object was converted, false otherwise. A null object will be "successfully" converted to a null
     *         string.
     */
     ...
     *
     */
    public void writeAttributeValue(String localName, boolean alwaysWriteEmptyString, Object value) throws
        ...
        if (this.tryConvertObjectToString(value, stringOut)) {
            ...
            throw new ServiceXmlSerializationException(
                    String.format(Strings.AttributeValueCannotBeSerialized, value.getClass().getName(), localName));
        }
    }
     ...
     *          the service xml serialization exception
     */
    public void writeAttributeValue(String namespacePrefix, String localName, Object value) throws
            ServiceXmlSerializationException {
        OutParam<String> stringOut = new OutParam<String>();
        String stringValue = null;
        if (this.tryConvertObjectToString(value, stringOut)) {
    ...
    protected void writeAttributeString(String localName, String stringValue) throws ServiceXmlSerializationException {
        try {
            ...
            throw new ServiceXmlSerializationException(
                    String.format(Strings.InvalidAttributeValue, stringValue, localName), e);
        }
    }
     ...
     *          Thrown if string value isn't valid for XML.
     */
    protected void writeAttributeString(String namespacePrefix, String localName, String stringValue) throws
            ServiceXmlSerializationException {
        try {
    ...
    public void writeValue(String value, String name) throws ServiceXmlSerializationException {
        try {
            ...
            // Bug E14:65046: XmlTextWriter will throw ArgumentException
            //if string includes invalid characters.
            throw new ServiceXmlSerializationException(String.format(Strings.InvalidElementStringValue, value, name),
                    e);
        }
    }
     ...
     *                            the service xml serialization exception
     */
    protected void writeElementValue(XmlNamespace xmlNamespace, String localName, String displayName,
                                     Object value) throws XMLStreamException, ServiceXmlSerializationException {
        String stringValue = null;
        ...
        if (this.tryConvertObjectToString(value, strOut)) {
            ...
            throw new ServiceXmlSerializationException(
                    String.format(Strings.ElementValueCannotBeSerialized, value.getClass().getName(), localName));
        }
    }
