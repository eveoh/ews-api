...
public final class GroupedFindItemsResults<TItem extends Item> implements Iterable<ItemGroup<TItem>> {
    ...
    /**
     * Gets a value indicating whether more items corresponding to the search criteria are available in the searched
     * folder.
     *
    ...
    /**
     * Sets a value indicating whether more items corresponding to the search criteria are available in the searched
     * folder.
     *
