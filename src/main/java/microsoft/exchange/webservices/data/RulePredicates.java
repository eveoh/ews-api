...
public final class RulePredicates extends ComplexProperty {
    ...
    /**
     * Gets the categories that an incoming message should be stamped with for the condition or exception to apply. To
     * disable this predicate, empty the list.
     */
    ...
    /**
     * Gets the strings that should appear in the body of incoming messages for the condition or exception to apply. To
     * disable this predicate, empty the list.
     */
    ...
    /**
     * Gets the strings that should appear in the headers of incoming messages for the condition or exception to
     * apply. To
     * disable this predicate, empty the list.
     */
    ...
    /**
     * Gets the strings that should appear in either the To or Cc fields of incoming messages for the condition or
    ...
    /**
     * Gets the strings that should appear in the From field of incoming messages for the condition or exception to
     * apply.
    ...
    /**
     * Gets the strings that should appear in either the body or the subject of incoming messages for the condition or
     * exception to apply. To disable this predicate, empty the list.
     */
    ...
    /**
     * Gets the strings that should appear in the subject of incoming messages for the condition or exception to
     * apply. To
     * disable this predicate, empty the list.
     */
    ...
    /**
     * Gets or sets the flag for action value that should appear on incoming messages for the condition or execption to
     * apply. To disable this predicate, set it to null.
     */
    ...
    /**
     * Gets the e-mail addresses of the senders of incoming messages for the condition or exception to apply. To disable
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must have attachments for the condition or exception to
     * apply.
     */
    ...
    /**
     * Gets or sets the importance that should be stamped on incoming messages for the condition or exception to
     * apply. To
     * disable this predicate, set it to null.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be approval requests for the condition or
     * exception
     * to apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be automatic forwards for the condition or
     * exception
     * to apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be automatic replies for the condition or
     * exception
     * to apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be S/MIME encrypted for the condition or
     * exception to
     * apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be meeting requests for the condition or
     * exception to
     * apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be meeting responses for the condition or
     * exception
     * to apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be non-delivery reports (NDR) for the condition or
     * exception to apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be permission controlled (RMS protected) for the
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be S/MIME signed for the condition or exception to
     * apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be voice mails for the condition or exception to
     * apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether incoming messages must be read receipts for the condition or exception to
     * apply.
     */
    ...
    /**
     * Gets the e-mail account names from which incoming messages must have been aggregated for the condition or
     * exception
    ...
    /**
     * Gets the item classes that must be stamped on incoming messages for the condition or exception to apply. To
     * disable
     * this predicate, empty the list.
     */
    ...
    /**
     * Gets the message classifications that must be stamped on incoming messages for the condition or exception to
     * apply.
     * To disable this predicate, empty the list.
     */
    ...
    /**
     * Gets or sets a value indicating whether the owner of the mailbox must NOT be a To recipient of the incoming
     * messages
    ...
    /**
     * Gets or sets a value indicating whether the owner of the mailbox must be a Cc recipient of incoming messages
     * for the
     * condition or exception to apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether the owner of the mailbox must be the only To recipient of incoming
     * messages
     * for the condition or exception to apply.
     */
    ...
    /**
     * Gets the e-mail addresses incoming messages must have been sent to for the condition or exception to apply. To
     * disable this predicate, empty the list.
     */
    ...
    /**
     * Gets or sets a value indicating whether the owner of the mailbox must be a To recipient of incoming messages
     * for the
     * condition or exception to apply.
     */
    ...
    /**
     * Gets or sets a value indicating whether the owner of the mailbox must be either a To or Cc recipient of incoming
    ...
    /**
     * Gets the date range within which incoming messages must have been received for the condition or exception to
     * apply.
    ...
    /**
     * Gets the minimum and maximum sizes incoming messages must have for the condition or exception to apply. To
     * disable
     * this predicate, set both its MinimumSize and MaximumSize properties to null.
     */
    ...
    protected void writeElementsToXml(EwsServiceXmlWriter writer) throws Exception {
        ...
        if (this.getFlaggedForAction() != null) {
            writer.writeElementValue(XmlNamespace.Types, XmlElementNames.FlaggedForAction,
        ...
        if (this.getIsApprovalRequest() != false) {
            writer.writeElementValue(XmlNamespace.Types, XmlElementNames.IsApprovalRequest,
                    this.getIsApprovalRequest());
        }

        if (this.getIsAutomaticForward() != false) {
            writer.writeElementValue(XmlNamespace.Types, XmlElementNames.IsAutomaticForward,
        ...
        if (this.getIsMeetingResponse() != false) {
            writer.writeElementValue(XmlNamespace.Types, XmlElementNames.IsMeetingResponse,
        ...
        if (this.getIsPermissionControlled() != false) {
            writer.writeElementValue(XmlNamespace.Types, XmlElementNames.IsPermissionControlled,
