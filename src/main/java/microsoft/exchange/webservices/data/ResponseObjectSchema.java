...
class ResponseObjectSchema extends ServiceObjectSchema {
    ...
    public static PropertyDefinition ReferenceItemId =
            new ComplexPropertyDefinition<ItemId>(ItemId.class, XmlElementNames.ReferenceItemId,
    ...
    public static final PropertyDefinition BodyPrefix =
            new ComplexPropertyDefinition<MessageBody>(MessageBody.class, XmlElementNames.NewBodyContent,
                    EnumSet.of(PropertyDefinitionFlags.CanSet), ExchangeVersion.Exchange2007_SP1,
    ...
    /**
     * Registers properties. IMPORTANT NOTE: PROPERTIES MUST BE REGISTERED IN SCHEMA ORDER (i.e. the same order as
     * they are
