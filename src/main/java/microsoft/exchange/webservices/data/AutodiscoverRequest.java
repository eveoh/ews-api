...
abstract class AutodiscoverRequest {
     ...
     * @throws EWSHttpException   the eWS http exception
     */
    private AutodiscoverResponse createRedirectionResponse(HttpWebRequest httpWebResponse) throws XMLStreamException,
     ...
     */
    protected void writeSoapRequest(URI requestUrl, EwsServiceXmlWriter writer) throws XMLStreamException,
     ...
     * @throws XMLStreamException the xML stream exception
     */
    protected void writeBodyToXml(EwsServiceXmlWriter writer) throws ServiceXmlSerializationException,
            XMLStreamException {
     ...
     * @throws Exception              the exception
     */
    protected AutodiscoverResponse readSoapBody(EwsXmlReader reader) throws InstantiationException,
     ...
     * @throws Exception              the exception
     */
    protected AutodiscoverResponse loadFromXml(EwsXmlReader reader) throws InstantiationException,
            IllegalAccessException, ParseException, Exception {
