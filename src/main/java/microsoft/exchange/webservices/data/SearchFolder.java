...
public class SearchFolder extends Folder {
    ...
    /**
     * Binds to an existing search folder and loads the specified set of properties. Calling this method results in a
     * call
     * to EWS.
     *
    ...
    /**
     * Binds to an existing search folder and loads its first class properties. Calling this method results in a call to
     * EWS.
     *
     * @param service the service
     * @param id      the id
     ...
     * @throws Exception the exception
     */
    public static SearchFolder bind(ExchangeService service, WellKnownFolderName name, PropertySet propertySet) throws
            Exception {
    ...
    /**
     * Initializes an unsaved local instance of the class. To bind to an existing search folder, use SearchFolder.Bind()
     * instead.
     *
     * @param service the service
     * @throws Exception the exception
    ...
    public SearchFolderParameters getSearchParameters() throws Exception {
        return (SearchFolderParameters) this.getPropertyBag()
                .getObjectFromPropertyDefinition(SearchFolderSchema.SearchParameters);
    }
