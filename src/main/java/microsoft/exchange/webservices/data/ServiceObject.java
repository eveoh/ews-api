...
public abstract class ServiceObject {
    ...
    /**
     * This methods lets subclasses of ServiceObject override the default mechanism by which the XML element name
     * associated with their type is retrieved.
     *
     * @return String
     */
    ...
    /**
     * GetXmlElementName retrieves the XmlElementName of this type based on the EwsObjectDefinition attribute that
     * decorates it, if present.
     *
    ...
    protected String getXmlElementName() {
        ...
        EwsUtilities.EwsAssert(!isNullOrEmpty(this.xmlElementName), "EwsObject.GetXmlElementName",
                String.format("The class %s does not have an " + "associated XML element name.",
     ...
     * @throws Exception the exception
     */
    protected void loadFromXml(EwsServiceXmlReader reader, boolean clearPropertyBag, PropertySet requestedPropertySet,
     ...
     * @throws Exception the exception
     */
    protected abstract void internalDelete(DeleteMode deleteMode, SendCancellationsMode sendCancellationsMode,
    ...
    public Object getObjectFromPropertyDefinition(PropertyDefinitionBase propertyDefinition) throws Exception {
        ...
        if (propDef != null) {
            ...
            if (extendedPropDef != null) {
                ...
                throw new NotSupportedException(String.format(Strings.OperationNotSupportedForPropertyDefinitionType,
     ...
     * @throws Exception the exception
     */
    protected <T> boolean tryGetExtendedProperty(Class<T> cls, ExtendedPropertyDefinition propertyDefinition,
     ...
     * @throws Exception
     */
    public boolean tryGetProperty(PropertyDefinitionBase propertyDefinition, OutParam<Object> propertyValue) throws
            Exception {
