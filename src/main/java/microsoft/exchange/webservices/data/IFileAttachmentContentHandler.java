...
/**
 * Defines a file attachment content handler. Application can implement IFileAttachmentContentHandler /// to provide a
 * stream in which the content of file attachment should be written.
 */
