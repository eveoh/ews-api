...
class MapiTypeConverter {
     ...
     */
    private static LazyMember<MapiTypeConverterMap> mapiTypeConverterMap =
     ...
     */
    protected static Object convertToValue(MapiPropertyType mapiPropType, String stringValue) throws
            ServiceXmlDeserializationException, FormatException {
    ...
    /**
     * Converts a MAPI Integer value. Usually the value is an integer but there are cases where the value has been
     * "schematized" to an Enumeration value (e.g. NoData) which we have no choice but to fallback and represent as a
     * string.
     *
