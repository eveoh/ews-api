...
final class LegacyAvailabilityTimeZoneTime extends ComplexProperty {
    ...
    /**
     * Gets  a value that represents: - The day of the month when Year is non zero,
     * - The index of the week in the month if
    ...
    /**
     * Gets  the year. If Year is 0, the time change occurs every year according to a recurring pattern; otherwise, the
     * time change occurs at the date specified by Day, Month, Year.
     *
     * @return the year
     */
