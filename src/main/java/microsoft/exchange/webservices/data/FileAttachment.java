...
public final class FileAttachment extends Attachment {
    ...
    void validate(int attachmentIndex) throws ServiceValidationException {
        try {
            if ((this.fileName == null || this.fileName.isEmpty()) && (this.content == null) &&
    ...
    /**
     * * Loads the content of the file attachment into the specified stream. Calling this method results in a call to
     * EWS.
     *
    ...
    public boolean isContactPhoto() throws ServiceVersionException {
        EwsUtilities
                .validatePropertyVersion(this.getOwner().getService(), ExchangeVersion.Exchange2010, "IsContactPhoto");
