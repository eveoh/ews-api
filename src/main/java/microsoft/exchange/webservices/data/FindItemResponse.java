...
public final class FindItemResponse<TItem extends Item> extends ServiceResponse {
    ...
    protected void readElementsFromXml(EwsServiceXmlReader reader) throws Exception {
        ...
        Integer nextPageOffset = moreItemsAvailable ?
                reader.readNullableAttributeValue(Integer.class, XmlAttributeNames.IndexedPagingOffset) : null;
     ...
     * @throws Exception          the exception
     */
    private void internalReadItemsFromXml(EwsServiceXmlReader reader, PropertySet propertySet,
                                          List<TItem> destinationList) throws XMLStreamException,
     ...
     * null
     * if the search operation did not specify grouping options.
     *
