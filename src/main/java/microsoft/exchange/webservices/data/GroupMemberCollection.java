...
public final class GroupMemberCollection extends ComplexPropertyCollection<GroupMember>
     ...
     * collection is
     * not cleared, then store PDL members collection is updated with "AppendToItemField".
     */
    ...
    /**
     * * Finds the member with the specified key in the collection.Members that have not yet been saved do not have a
     * key.
     *
     * @param key the key
     ...
     * @throws Exception the exception
     */
    public boolean writeSetUpdateToXml(EwsServiceXmlWriter writer, ServiceObject ownerObject,
     ...
     */
    private void writeDeleteMembersCollectionToXml(EwsServiceXmlWriter writer) throws XMLStreamException,
     ...
     *                            the service xml serialization exception
     */
    private void writeDeleteMembersToXml(EwsServiceXmlWriter writer, List<GroupMember> members) throws
     ...
     * @throws Exception the exception
     */
    private void writeSetOrAppendMembersToXml(EwsServiceXmlWriter writer, List<GroupMember> members,
