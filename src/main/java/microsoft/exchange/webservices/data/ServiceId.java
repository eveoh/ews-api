...
public abstract class ServiceId extends ComplexProperty {
    ...
    /**
     * Gets the change key associated with the Exchange object. The change key represents the version of the associated
     * item or folder.
     *
    ...
    /**
     * Sets the change key associated with the Exchange object. The change key represents the version of the associated
     * item or folder.
     *
    ...
    public boolean sameIdAndChangeKey(ServiceId other) {
        if (this.equals(other)) {
            return ((this.getChangeKey() == null) && (other.getChangeKey() == null)) ||
    ...
    /**
     * Determines whether the specified instance is equal to the current instance. We do not consider the ChangeKey for
     * ServiceId.Equals.
     *
