...
public class Contact extends Item {
    ...
    /**
     * Binds to an existing contact and loads the specified set of properties. Calling this method results in a call to
     * EWS.
     *
     * @param service     the service
     * @param id          the id
    ...
    public FileAttachment getContactPictureAttachment() throws ServiceLocalException {
        EwsUtilities
                .validateMethodVersion(this.getService(), ExchangeVersion.Exchange2010, "GetContactPictureAttachment");
    ...
    protected void validate() throws ServiceVersionException, Exception {
        ...
        if (this.tryGetProperty(ContactSchema.FileAsMapping, outParam)) {
            ...
            EwsUtilities.validateEnumVersionValue((FileAsMapping) fileAsMapping,
     ...
     * calculated
     * based on the value of the FileAsMapping property.
     *
     * @return the file as
     * @throws ServiceLocalException the service local exception
     */
    ...
    /**
     * Gets an indexed list of e-mail addresses for the contact. For example, to set the first e-mail address, use the
     * following syntax: EmailAddresses[EmailAddressKey.EmailAddress1] = "john.doe@contoso.com"
     *
    ...
    /**
     * Gets an indexed list of physical addresses for the contact. For example, to set the first business address,
     * use the
     * following syntax: physical[PhysicalAddressKey.Business] = new PhysicalAddressEntry()
     *
    ...
    public PhysicalAddressDictionary getPhysicalAddresses() throws ServiceLocalException {
        return (PhysicalAddressDictionary) this.getPropertyBag()
                .getObjectFromPropertyDefinition(ContactSchema.PhysicalAddresses);
    }

    /**
     * Gets an indexed list of phone numbers for the contact. For example, to set the home phone number,
     * use the following
     * syntax: PhoneNumbers[PhoneNumberKey.HomePhone] = "phone number"
     *
    ...
    /**
     * Gets an indexed list of Instant Messaging addresses for the contact. For example, to set the first IM address,
     * use
     * the following syntax: ImAddresses[ImAddressKey.ImAddress1] = "john.doe@contoso.com"
     *
    ...
    public PhysicalAddressIndex getPostalAddressIndex() throws ServiceLocalException {
        return (PhysicalAddressIndex) getPropertyBag()
                .getObjectFromPropertyDefinition(ContactSchema.PostalAddressIndex);
    }
