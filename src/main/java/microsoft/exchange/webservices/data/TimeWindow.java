...
public class TimeWindow implements ISelfValidate {
     ...
     */
    private static void writeToXml(EwsServiceXmlWriter writer, String xmlElementName, Object startTime,
                                   Object endTime) throws XMLStreamException, ServiceXmlSerializationException {
     ...
     *                            the service xml serialization exception
     */
    protected void writeToXmlUnscopedDatesOnly(EwsServiceXmlWriter writer, String xmlElementName) throws
