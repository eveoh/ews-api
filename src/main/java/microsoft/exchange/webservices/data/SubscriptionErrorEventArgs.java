...
public class SubscriptionErrorEventArgs { //TODO extends EventObject {
     ...
     *
     * @param subscription The subscription for which an error occurred. If subscription is null,
     *                     the error applies to the
     *                     entire connection.
     * @param exception    The exception representing the error. If exception is null,
     *                     the connection was cleanly closed by
     *                     the server.
     */
    ...
    /**
     * Sets the subscription for which an error occurred. If Subscription is null, the error applies to the entire
     * connection.
     */
