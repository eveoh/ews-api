...
public final class GetEventsResults {
     ...
     * entry to the Map here.
     */
    private static LazyMember<Map<String, EventType>> xmlElementNameToEventTypeMap =
            new LazyMember<Map<String, EventType>>(new ILazyMember<Map<String, EventType>>() {
                @Override
    ...
    protected void loadFromXml(EwsServiceXmlReader reader) throws Exception {
        ...
        this.moreEventsAvailable =
                reader.readElementValue(Boolean.class, XmlNamespace.Types, XmlElementNames.MoreEvents);
     ...
     * @throws Exception the exception
     */
    private void loadNotificationEventFromXml(EwsServiceXmlReader reader, String eventElementName,
