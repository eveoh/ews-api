...
public class MeetingRequest extends MeetingMessage implements ICalendarActionProvider {
    ...
    /**
     * Binds to an existing meeting response and loads the specified set of properties. Calling this method results in a
     * call to EWS.
     *
     ...
     * @return A MeetingResponse instance representing the meeting request corresponding to the specified Id.
     */
    ...
    public MeetingRequestType getMeetingRequestType() throws ServiceLocalException {
        return (MeetingRequestType) this.getPropertyBag()
                .getObjectFromPropertyDefinition(MeetingRequestSchema.MeetingRequestType);
    }
    ...
    public LegacyFreeBusyStatus getIntendedFreeBusyStatus() throws ServiceLocalException {
        return (LegacyFreeBusyStatus) this.getPropertyBag()
                .getObjectFromPropertyDefinition(MeetingRequestSchema.IntendedFreeBusyStatus);
    ...
    public int getConflictingMeetingCount() throws NumberFormatException, ServiceLocalException {
        return (Integer.parseInt(
                this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.ConflictingMeetingCount)
                        .toString()));
    }
    ...
    public int getAdjacentMeetingCount() throws NumberFormatException, ServiceLocalException {
        return (Integer.parseInt(
                this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.AdjacentMeetingCount)
                        .toString()));
    }
    ...
    public int getAppointmentState() throws NumberFormatException, ServiceLocalException {
        return (Integer.parseInt(
                this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.AppointmentState).toString()));
    }
    ...
    public int getConferenceType() throws NumberFormatException, ServiceLocalException {
        return (Integer.parseInt(
                this.getPropertyBag().getObjectFromPropertyDefinition(AppointmentSchema.ConferenceType).toString()));
    }
