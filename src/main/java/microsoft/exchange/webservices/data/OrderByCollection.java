...
public final class OrderByCollection implements Iterable<Map<PropertyDefinitionBase, SortDirection>> {
     ...
     */
    public void add(PropertyDefinitionBase propertyDefinition, SortDirection sortDirection) throws
            ServiceLocalException {
        if (this.contains(propertyDefinition)) {
            throw new ServiceLocalException(String.format(Strings.PropertyAlreadyExistsInOrderByCollection,
    ...
    public boolean remove(PropertyDefinitionBase propertyDefinition) {
        List<Map<PropertyDefinitionBase, SortDirection>> removeList =
                new ArrayList<Map<PropertyDefinitionBase, SortDirection>>();
        for (Map propDefSortOrderPair : propDefSortOrderPairList) {
     ...
     */
    protected void writeToXml(EwsServiceXmlWriter writer, String xmlElementName) throws XMLStreamException,
