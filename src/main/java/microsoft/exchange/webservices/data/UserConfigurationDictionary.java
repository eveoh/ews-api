...
public final class UserConfigurationDictionary extends ComplexProperty implements Iterable<Object> {
     ...
     * @param value When this method returns, the value associated with the specified key,
     ...
     *                            the service xml serialization exception
     */
    private void writeObjectToXml(EwsServiceXmlWriter writer, String xmlElementName, Object dictionaryObject) throws
     ...
     *                            the service xml serialization exception
     */
    private void writeObjectValueToXml(EwsServiceXmlWriter writer, Object dictionaryObject) throws XMLStreamException,
            ServiceXmlSerializationException {
        EwsUtilities.EwsAssert(writer != null, "UserConfigurationDictionary.WriteObjectValueToXml", "writer is null");
        EwsUtilities.EwsAssert(dictionaryObject != null, "UserConfigurationDictionary.WriteObjectValueToXml",
        ...
        if (dictionaryObjectAsStringArray != null) {
            ...
            if (dictionaryObjectAsByteArray != null) {
                ...
                if (dictionaryObject.getClass().equals(Boolean.TYPE)) {
                    ...
                    EwsUtilities.EwsAssert(false, "UserConfigurationDictionary." + "WriteObjectValueToXml",
                            "Unsupported type: " + dictionaryObject.getClass().toString());
                }
            }
    ...
    private void writeEntryTypeToXml(EwsServiceXmlWriter writer,
                                     UserConfigurationDictionaryObjectType dictionaryObjectType) throws
            XMLStreamException, ServiceXmlSerializationException {
     ...
     *                            the service xml serialization exception
     */
    private void writeEntryValueToXml(EwsServiceXmlWriter writer, String value) throws XMLStreamException,
            ServiceXmlSerializationException {
     ...
     */
    protected void loadFromXml(EwsServiceXmlReader reader, XmlNamespace xmlNamespace, String xmlElementName) throws
            Exception {
     ...
     * @throws Exception the exception
     */
    private List<String> getObjectValue(EwsServiceXmlReader reader, UserConfigurationDictionaryObjectType type) throws
            Exception {
        EwsUtilities.EwsAssert(reader != null, "UserConfigurationDictionary.LoadFromXml", "reader is null");
        ...
        do {
            ...
            if (reader.isEmptyElement()) {
                ...
                if (type.equals(UserConfigurationDictionaryObjectType.String) ||
                        type.equals(UserConfigurationDictionaryObjectType.
                                StringArray)) {
                    value = "";
                }
                else {
    ...
    private void validateArrayObject(Object[] dictionaryObjectAsArray) throws ServiceLocalException {
        ...
        if (dictionaryObjectAsArray instanceof String[]) {
            ...
            throw new ServiceLocalException(
                    String.format(Strings.ObjectTypeNotSupported, dictionaryObjectAsArray.getClass()));
        }
    }
    ...
    private void validateObjectType(Type type) throws ServiceLocalException {
        ...
        if (type.equals(Boolean.TYPE) || type.equals(Byte.TYPE) || type.equals(Date.class) ||
                type.equals(Integer.TYPE) || type.equals(Long.TYPE) || type.equals(String.class) ||
