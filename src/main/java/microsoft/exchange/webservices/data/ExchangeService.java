...
public final class ExchangeService extends ExchangeServiceBase implements IAutodiscoverRedirectionUrl {
     ...
     * @throws Exception the exception
     */
    public FindFoldersResults findFolders(FolderId parentFolderId, SearchFilter searchFilter, FolderView view) throws
            Exception {
        ...
        ServiceResponseCollection<FindFolderResponse> responses =
                this.internalFindFolders(folderIdArray, searchFilter, view, ServiceErrorHandling.ThrowOnError);
    ...
    public FindFoldersResults findFolders(FolderId parentFolderId, FolderView view) throws Exception {
        ...
        ServiceResponseCollection<FindFolderResponse> responses =
                this.internalFindFolders(folderIdArray, null, /* searchFilter */
    ...
    protected <TFolder extends Folder> TFolder bindToFolder(Class<TFolder> cls, FolderId folderId,
        ...
        if (result instanceof Folder) {
            ...
            throw new ServiceLocalException(
                    String.format("%s,%s,%s", Strings.FolderTypeNotCompatible, result.getClass().getName(),
                            cls.getName()));
        }
    }
    ...
    private ServiceResponseCollection<ServiceResponse> internalCreateItems(Collection<Item> items,
                                                                           ...
                                                                           ServiceErrorHandling errorHandling) throws
            Exception {
    ...
    public ServiceResponseCollection<ServiceResponse> createItems(Collection<Item> items, FolderId parentFolderId,
                                                                  MessageDisposition messageDisposition,
                                                                  SendInvitationsMode sendInvitationsMode) throws
            Exception {
    ...
    public ServiceResponseCollection<UpdateItemResponse> updateItems(Iterable<Item> items,
                                                                     ...
                                                                     MessageDisposition messageDisposition,
                                                                     SendInvitationsOrCancellationsMode
                                                                             sendInvitationsOrCancellationsMode) throws
            Exception {
    ...
    protected Item updateItem(Item item, FolderId savedItemsDestinationFolderId,
        ...
        ServiceResponseCollection<UpdateItemResponse> responses =
                this.internalUpdateItems(itemIdArray, savedItemsDestinationFolderId, conflictResolution,
                        messageDisposition, sendInvitationsOrCancellationsMode, ServiceErrorHandling.ThrowOnError);
     ...
     * @param destinationFolderId The folder in which to save sent messages, meeting invitations or cancellations. If
     *                            null,
     *                            the message, meeting invitation or cancellation is saved in the Sent Items folder
    ...
    public FindItemsResults<Item> findItems(FolderId parentFolderId, String queryString, ItemView view) throws
            Exception {
        EwsUtilities.validateParamAllowNull(queryString, "queryString");
     ...
     */
    @SuppressWarnings("unchecked")
    public FindItemsResults<Item> findItems(FolderId parentFolderId, SearchFilter searchFilter, ItemView view) throws
            Exception {
        EwsUtilities.validateParamAllowNull(searchFilter, "searchFilter");
        List folderIdArray = new ArrayList();
        folderIdArray.add(parentFolderId);
        ServiceResponseCollection<FindItemResponse<Item>> responses =
                this.findItems(folderIdArray, searchFilter, null, /* queryString */
                        view, null, /* groupBy */
                        ServiceErrorHandling.ThrowOnError);
     ...
     * @throws Exception the exception
     */
    public GroupedFindItemsResults<Item> findItems(FolderId parentFolderId, ItemView view, Grouping groupBy) throws
            Exception {
        EwsUtilities.validateParam(groupBy, "groupBy");
     ...
     * @throws Exception the exception
     */
    public FindItemsResults<Appointment> findAppointments(FolderId parentFolderId, CalendarView calendarView) throws
            Exception {
        List<FolderId> folderIdArray = new ArrayList<FolderId>();
        folderIdArray.add(parentFolderId);

        ServiceResponseCollection<FindItemResponse<Appointment>> response =
                this.findItems(folderIdArray, null, /* searchFilter */
    ...
    protected Item bindToItem(ItemId itemId, PropertySet propertySet) throws Exception {
        ...
        ServiceResponseCollection<GetItemResponse> responses =
                this.internalBindToItems(itmLst, propertySet, ServiceErrorHandling.ThrowOnError);
     ...
     * @throws Exception the exception
     */
    protected <TItem extends Item> TItem bindToItem(Class<TItem> c, ItemId itemId, PropertySet propertySet) throws
            Exception {
        ...
        if (result instanceof Item) {
            ...
            throw new ServiceLocalException(
                    String.format(Strings.ItemTypeNotCompatible, result.getClass().getName(), c.getName()));
        }
        // return (TItem)result;
    }
    ...
    public ServiceResponseCollection<ServiceResponse> deleteItems(Iterable<ItemId> itemIds, DeleteMode deleteMode,
                                                                  SendCancellationsMode sendCancellationsMode,
                                                                  AffectedTaskOccurrence affectedTaskOccurrences) throws
            Exception {
        EwsUtilities.validateParamCollection(itemIds.iterator(), "itemIds");
    ...
    public NameResolutionCollection resolveName(String nameToResolve, Iterable<FolderId> parentFolderIds,
                                                ...
                                                PropertySet contactDataPropertySet) throws Exception {
    ...
    public NameResolutionCollection resolveName(String nameToResolve, ResolveNameSearchLocation searchScope,
                                                boolean returnContactDetails, PropertySet contactDataPropertySet) throws
            Exception {
    ...
    public AsyncRequestResult beginSubscribeToPullNotifications(AsyncCallback callback, Object state,
                                                                ...
                                                                String watermark, EventType... eventTypes) throws
            Exception {
        EwsUtilities.validateParamCollection(folderIds.iterator(), "folderIds");
    ...
    public PullSubscription subscribeToPullNotificationsOnAllFolders(int timeout, String watermark,
                                                                     EventType... eventTypes) throws Exception {
        EwsUtilities
                .validateMethodVersion(this, ExchangeVersion.Exchange2010, "SubscribeToPullNotificationsOnAllFolders");
    ...
    private SubscribeToPullNotificationsRequest buildSubscribeToPullNotificationsRequest(Iterable<FolderId> folderIds,
                                                                                         int timeout, String watermark,
                                                                                         EventType... eventTypes) throws
            Exception {
     ...
     * @returns An IAsyncResult that references the asynchronous request.
     */
    protected IAsyncResult beginUnsubscribe(AsyncCallback callback, Object state, String subscriptionId) throws
            Exception {
     ...
     * @throws Exception
     */
    protected IAsyncResult beginGetEvents(AsyncCallback callback, Object state, String subscriptionId,
     ...
     * @param asyncResult An IAsyncResult that references the asynchronous request.
     * @throws Exception
     * @returns A GetEventsResults containing a list of events associated with the subscription.
     */
    ...
    public PushSubscription subscribeToPushNotificationsOnAllFolders(URI url, int frequency, String watermark,
                                                                     EventType... eventTypes) throws Exception {
        EwsUtilities
                .validateMethodVersion(this, ExchangeVersion.Exchange2010, "SubscribeToPushNotificationsOnAllFolders");
...
/*	public StreamingSubscription subscribeToStreamingNotifications(
    ...
    public StreamingSubscription endSubscribeToStreamingNotifications(IAsyncResult asyncResult) throws
            IndexOutOfBoundsException, Exception {
        EwsUtilities
                .validateMethodVersion(this, ExchangeVersion.Exchange2010_SP1, "EndSubscribeToStreamingNotifications");

        SubscribeToStreamingNotificationsRequest request = AsyncRequestResult.extractServiceRequest(this, asyncResult);
        //   SubscribeToStreamingNotificationsRequest request = AsyncRequestResult
        // .extractServiceRequest<SubscribeToStreamingNotificationsRequest>(this, asyncResult);
        return request.endExecute(asyncResult).getResponseAtIndex(0).getSubscription();
    }
    ...
    public ChangeCollection<ItemChange> syncFolderItems(FolderId syncFolderId, PropertySet propertySet,
                                                        ...
                                                        SyncFolderItemsScope syncScope, String syncState) throws
            Exception {
        return this
                .buildSyncFolderItemsRequest(syncFolderId, propertySet, ignoredItemIds, maxChangesReturned, syncScope,
     ...
     * @throws
     */
    public ChangeCollection<FolderChange> syncFolderHierarchy(PropertySet propertySet, String syncState) throws
            Exception {
     ...
     * @throws Exception
     */
	/*public IAsyncResult beginSyncFolderHierarchy(FolderId syncFolderId, PropertySet propertySet,
	String syncState) throws Exception {
    ...
    public GetUserAvailabilityResults getUserAvailability(Iterable<AttendeeInfo> attendees, TimeWindow timeWindow,
                                                          ...
                                                          AvailabilityOptions options) throws Exception {
     ...
     * @throws Exception
     */
    public Collection<Conversation> findConversation(ConversationIndexedItemView view, FolderId folderId) throws
            Exception {
     ...
     * @param processRightAway    True to process at once . This is blocking and false to let the Assitant process it in
     *                            the back ground
     * @param categories          Catgories that need to be stamped can be null or empty
     * @param enableAlwaysDelete  True moves every current and future messages in the conversation to deleted items
     *                            folder.
     *                            False stops the alwasy delete action. This is applicable only if the action is
     *                            AlwaysDelete
     * @param destinationFolderId Applicable if the action is AlwaysMove. This moves every current message and future
     *                            message in the conversation to the specified folder. Can be null if tis is then it
     *                            stops
    ...
    public ServiceResponseCollection<ServiceResponse> enableAlwaysCategorizeItemsInConversations(
            Iterable<ConversationId> conversationId, Iterable<String> categories, boolean processSynchronously) throws
            Exception {
        EwsUtilities.validateParamCollection(categories.iterator(), "categories");
        return this
                .applyConversationAction(ConversationActionType.AlwaysCategorize, conversationId, processSynchronously,
    ...
    public ServiceResponseCollection<ServiceResponse> enableAlwaysMoveItemsInConversations(
            Iterable<ConversationId> conversationId, FolderId destinationFolderId, boolean processSynchronously) throws
            Exception {
        EwsUtilities.validateParam(destinationFolderId, "destinationFolderId");
        return this
                .applyConversationAction(ConversationActionType.AlwaysMove, conversationId, processSynchronously, null,
    ...
    public ServiceResponseCollection<ServiceResponse> disableAlwaysMoveItemsInConversations(
        ...
        return this
                .applyConversationAction(ConversationActionType.AlwaysMove, conversationIds, processSynchronously, null,
     ...
     * @throws Exception the exception
     */
    public Collection<DelegateUserResponse> removeDelegates(Mailbox mailbox, Iterable<UserId> userIds) throws
            Exception {
        EwsUtilities.validateParam(mailbox, "mailbox");
     ...
     * @throws Exception the exception
     */
    public DelegateInformation getDelegates(Mailbox mailbox, boolean includePermissions, UserId... userIds) throws
            Exception {
        ArrayList<UserId> delUser = new ArrayList<UserId>();
        for (UserId user : userIds) {
            delUser.add(user);
    ...
    public DelegateInformation getDelegates(Mailbox mailbox, boolean includePermissions,
        ...
        DelegateInformation delegateInformation =
                new DelegateInformation((List<DelegateUserResponse>) response.getDelegateUserResponses(),
    ...
    /**
     * Default implementation of AutodiscoverRedirectionUrlValidationCallback. Always returns true indicating that the URL
     * can be used.
     *
     ...
     */
    private boolean defaultAutodiscoverRedirectionUrlValidationCallback(String redirectionUrl) throws
     ...
     * @throws Exception the exception
     */
    public void autodiscoverUrl(String emailAddress, IAutodiscoverRedirectionUrl validateRedirectionUrlCallback) throws
            Exception {
        ...
        exchangeServiceUrl =
                this.getAutodiscoverUrl(emailAddress, ExchangeVersion.Exchange2007_SP1, validateRedirectionUrlCallback);
    ...
    private URI getAutodiscoverUrl(String emailAddress, ExchangeVersion requestedServerVersion,
        ...
        GetUserSettingsResponse response = autodiscoverService
                .getUserSettings(emailAddress, UserSettingName.InternalEwsUrl, UserSettingName.ExternalEwsUrl);
        ...
        switch (response.getErrorCode()) {
            ...
            case InvalidRequest:
                throw new ServiceRemoteException(
                        String.format(Strings.InvalidAutodiscoverRequest, response.getErrorMessage()));

            default:
                this.traceMessage(TraceFlags.AutodiscoverConfiguration,
                        String.format("No EWS Url returned for user %s, " + "error code is %s", emailAddress,
    ...
    private URI getEwsUrlFromResponse(GetUserSettingsResponse response, boolean isExternal) throws URISyntaxException,
            AutodiscoverLocalException {
        String uriString;
     ...
     */
    public boolean autodiscoverRedirectionUrlValidationCallback(String redirectionUrl) throws
            AutodiscoverLocalException {
