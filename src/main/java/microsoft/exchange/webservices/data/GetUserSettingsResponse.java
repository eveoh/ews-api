    ...
    protected void loadUserSettingsFromXml(EwsXmlReader reader) throws Exception {
        if (!reader.isEmptyElement()) {
            do {
                ...
                if ((reader.getNodeType().getNodeType() == XMLNodeType.START_ELEMENT) &&
                        (reader.getLocalName().equals(XmlElementNames.UserSetting))) {
                    String settingClass =
                    ...
                    if (settingClass.equals(XmlElementNames.StringSetting)) {
                        ...
                        EwsUtilities.EwsAssert(false, "GetUserSettingsResponse." + "LoadUserSettingsFromXml",
    ...
    private void loadUserSettingErrorsFromXml(EwsXmlReader reader) throws Exception {
        if (!reader.isEmptyElement()) {
            do {
                ...
                if ((reader.getNodeType().getNodeType() == XMLNodeType.START_ELEMENT) &&
                        (reader.getLocalName().equals(XmlElementNames.UserSettingError))) {
