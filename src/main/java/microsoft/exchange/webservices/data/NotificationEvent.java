...
public abstract class NotificationEvent {
    ...
    /**
     * Id of the old parent folder of the item or folder this event applies to. This property is only meaningful when
     * EventType is equal to either EventType.Moved or EventType.Copied. For all other event types,
     * oldParentFolderId will
     * be null
     */
     ...
     */
    protected void internalLoadFromXml(EwsServiceXmlReader reader) throws ServiceXmlDeserializationException,
