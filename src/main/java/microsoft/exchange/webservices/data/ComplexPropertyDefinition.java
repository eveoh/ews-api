...
class ComplexPropertyDefinition<TComplexProperty extends ComplexProperty> extends ComplexPropertyDefinitionBase {
     ...
     */
    protected ComplexPropertyDefinition(Class<TComplexProperty> cls, String xmlElementName,
     ...
     * @param propertyCreationDelegate Delegate used to create instances of ComplexProperty.
     */
    protected ComplexPropertyDefinition(Class<TComplexProperty> cls, String xmlElementName, String uri,
    ...
    protected ComplexPropertyDefinition(String xmlElementName, String uri, ExchangeVersion version,
                                        ICreateComplexPropertyDelegate<TComplexProperty> propertyCreationDelegate) {
        super(xmlElementName, uri, version);
        this.propertyCreationDelegate = propertyCreationDelegate;
    }
     ...
     * @param propertyCreationDelegate the property creation delegate
     */
    public ComplexPropertyDefinition(String attachments, String xmlElementName, ExchangeVersion version,
