...
public abstract class Recurrence extends ComplexProperty {
     ...
     */
    protected void internalWritePropertiesToXml(EwsServiceXmlWriter writer) throws XMLStreamException,
            ServiceXmlSerializationException, ServiceValidationException, Exception {
    }
     ...
     * @throws ServiceValidationException the service validation exception
     */
    protected <T> T getFieldValueOrThrowIfNull(Class<T> cls, Object value, String name) throws
    ...
    /**
     * Represents a regeneration pattern, as used with recurring tasks, where each occurrence happens a specified
     * number of
     * days after the previous one is completed.
     */
    ...
    /**
     * Represents a recurrence pattern where each occurrence happens on a specific day a specific number of months after
     * the previous one.
     */
     ...
     * Represents a regeneration pattern, as used with recurring tasks, where each occurrence happens a specified
     * number of
     * months after the previous one is completed.
     */
    public final static class MonthlyRegenerationPattern extends IntervalPattern {
         ...
         * instance is
         * regeneration pattern; otherwise, <c>false</c>. </value>
         *
         * @return true, if is regeneration pattern
         */
        protected boolean isRegenerationPattern() {
    ...
    /**
     * Represents a recurrence pattern where each occurrence happens on a relative day a specific number of months after
     * the previous one.
     */
    public final static class RelativeMonthlyPattern extends IntervalPattern {
         ...
         * @throws ArgumentOutOfRangeException the argument out of range exception
         */
        public RelativeMonthlyPattern(Date startDate, int interval, DayOfTheWeek dayOfTheWeek,
                                      DayOfTheWeekIndex dayOfTheWeekIndex) throws ArgumentOutOfRangeException {
            super(startDate, interval);
        ...
        public DayOfTheWeekIndex getDayOfTheWeekIndex() throws ServiceValidationException {
            return this
                    .getFieldValueOrThrowIfNull(DayOfTheWeekIndex.class, this.dayOfTheWeekIndex, "DayOfTheWeekIndex");
        }
    ...
    public final static class RelativeYearlyPattern extends Recurrence {
         ...
         * @param dayOfTheWeekIndex the day of the week index
         */
        public RelativeYearlyPattern(Date startDate, Month month, DayOfTheWeek dayOfTheWeek,
    ...
    public final static class WeeklyPattern extends IntervalPattern implements IComplexPropertyChangedDelegate {
        ...
        /**
         * Initializes a new instance of the WeeklyPattern class. specific days a specific number of weeks after the
         * previous
         * one.
         */
         ...
         * @throws ArgumentOutOfRangeException the argument out of range exception
         */
        public WeeklyPattern(Date startDate, int interval, DayOfTheWeek... daysOfTheWeek) throws
        ...
        protected void internalWritePropertiesToXml(EwsServiceXmlWriter writer) throws Exception {
            ...
            if (this.firstDayOfWeek != null) {
                ...
                EwsUtilities.validatePropertyVersion((ExchangeService) writer.getService(),
                        ExchangeVersion.Exchange2010_SP1, "FirstDayOfWeek");
     ...
     * Represents a regeneration pattern, as used with recurring tasks, where each occurrence happens a specified
     * number of
     * weeks after the previous one is completed.
     */
    ...
    /**
     * Represents a regeneration pattern, as used with recurring tasks, where each occurrence happens a specified number of
     * years after the previous one is completed.
     */
