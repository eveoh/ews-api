...
class TimeZoneTransitionGroup extends ComplexProperty {
    ...
    protected static class CustomTimeZoneCreateParams {
        ...
        /**
         * Gets a value indicating whether the custom time zone should have a daylight period. <value> <c>true</c> if
         * the
         * custom time zone should have a daylight period; otherwise, <c>false</c>. </value>
         *
    ...
    /**
     * Gets a value indicating whether this group contains a transition to the Daylight period. <value><c>true</c> if
     * this
     * group contains a transition to daylight; otherwise, <c>false</c>.</value>
     *
