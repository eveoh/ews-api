...
public final class StreamingSubscriptionConnection
        implements Closeable, HangingServiceRequestBase.IHandleResponseObject,
     ...
     * @param lifetime The maximum time, in minutes, the connection will remain open. Lifetime must be between 1 and 30.
     * @throws Exception
     */
     ...
     * @throws Exception
     */
    public StreamingSubscriptionConnection(ExchangeService service, Iterable<StreamingSubscription> subscriptions,
    ...
    public void open() throws ServiceLocalException, Exception {
        synchronized (this) {
            ...
            this.currentHangingRequest = new GetStreamingEventsRequest(this.session, this, this.subscriptions.keySet(),
     ...
     * @param args   The Microsoft.Exchange.WebServices.Data. HangingRequestDisconnectEventArgs instance containing the
     *               event data.
     */
    ...
    private void issueGeneralFailure(GetStreamingEventsResponse gseResponse) {
        SubscriptionErrorEventArgs eventArgs =
                new SubscriptionErrorEventArgs(null, new ServiceResponseException(gseResponse));
