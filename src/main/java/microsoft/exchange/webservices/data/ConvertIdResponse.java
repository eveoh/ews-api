...
public final class ConvertIdResponse extends ServiceResponse {
     ...
     */
    @Override
    protected void readElementsFromXml(EwsServiceXmlReader reader) throws InstantiationException,
            IllegalAccessException, ServiceLocalException, Exception {
        ...
        if (alternateIdClass.equals(AlternateId.SchemaTypeName)) {
            ...
            EwsUtilities.EwsAssert(false, "ConvertIdResponse.ReadElementsFromXml",
