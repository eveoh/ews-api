...
public class UserConfiguration {
     ...
     */
    private final static EnumSet<UserConfigurationProperties> PropertiesAvailableForNewObject =
            EnumSet.of(UserConfigurationProperties.BinaryData, UserConfigurationProperties.Dictionary,
     ...
     */
    private static void writeByteArrayToXml(EwsServiceXmlWriter writer, byte[] byteArray, String xmlElementName) throws
        ...
        EwsUtilities
                .EwsAssert(xmlElementName != null, "UserConfiguration.WriteByteArrayToXml", "xmlElementName is null");
     ...
     * @throws Exception the exception
     */
    protected static void writeUserConfigurationNameToXml(EwsServiceXmlWriter writer, XmlNamespace xmlNamespace,
    ...
    protected UserConfiguration(ExchangeService service,
                                EnumSet<UserConfigurationProperties> requestedProperties) throws Exception {
        EwsUtilities.validateParam(service, "service");

        if (service.getRequestedServerVersion().ordinal() < this.ObjectVersion.ordinal()) {
            throw new ServiceVersionException(
                    String.format(Strings.ObjectTypeIncompatibleWithRequestVersion, this.getClass().getName(),
                            this.ObjectVersion));
        }
    ...
    /**
     * Binds to an existing user configuration and loads the specified properties. Calling this method results in a
     * call to
     * EWS.
     *
     * @param service        The service to which the user configuration is bound.
     ...
     * @throws Exception                 the exception
     */
    public static UserConfiguration bind(ExchangeService service, String name, FolderId parentFolderId,
                                         UserConfigurationProperties properties) throws IndexOutOfBoundsException,
            Exception {
     ...
     * @throws Exception                 the exception
     */
    public static UserConfiguration bind(ExchangeService service, String name, WellKnownFolderName parentFolderName,
                                         UserConfigurationProperties properties) throws IndexOutOfBoundsException,
            Exception {
    ...
    /**
     * Updates the user configuration by applying local changes to the Exchange server. Calling this method results in a
     * call to EWS
     *
     * @throws Exception the exception
     */
     ...
     * @throws Exception the exception
     */
    protected void writeToXml(EwsServiceXmlWriter writer, XmlNamespace xmlNamespace, String xmlElementName) throws
            Exception {
     ...
     *                            the service xml serialization exception
     */
    private void writeXmlDataToXml(EwsServiceXmlWriter writer) throws XMLStreamException,
     ...
     *                            the service xml serialization exception
     */
    private void writeBinaryDataToXml(EwsServiceXmlWriter writer) throws XMLStreamException,
            ServiceXmlSerializationException {
            ...
            if (reader.getNodeType().getNodeType() == XMLNodeType.START_ELEMENT) {
                if (reader.getLocalName().equals(XmlElementNames.UserConfigurationName)) {
                    ...
                    EwsUtilities.EwsAssert(this.name.equals(responseName), "UserConfiguration.LoadFromXml",
                            "UserConfigurationName does not match: Expected: " + this.name + " Name in response: " +
                                    responseName);
