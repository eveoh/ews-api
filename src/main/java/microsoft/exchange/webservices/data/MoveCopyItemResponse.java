...
public final class MoveCopyItemResponse extends ServiceResponse implements IGetObjectInstanceDelegate<ServiceObject> {
    ...
    protected void readElementsFromXml(EwsServiceXmlReader reader) throws Exception {
        ...
        List<Item> items =
                reader.readServiceObjectsCollectionFromXml(XmlElementNames.Items, this, false, /* clearPropertyBag */
    ...
    /**
     * * Gets the copied or moved item. Item is null if the copy or move operation was between two mailboxes or between a
