...
interface ICalendarActionProvider {
     ...
     * @return A CalendarActionResults object containing the various items that were created or modified as a result of
     *         this operation.
     ...
     *
     * @param tentative Indicates whether the new AcceptMeetingInvitationMessage should represent a Tentative accept
