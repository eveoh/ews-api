...
public class SafeXmlSchema extends Schema {
     ...
     */
    public static Schema Read(InputStream stream, ValidationEventHandler validationEventHandler) throws
            XMLStreamException {
     ...
     * @param validationEventHandler The validation event handler that receives information about the XML Schema syntax
     *                               errors.
     * @return The XmlSchema object representing the XML Schema.
     * @throws XMLStreamException
     */

    public static Schema Read(XMLStreamReader reader, ValidationEventHandler validationEventHandler) throws
            XMLStreamException {
