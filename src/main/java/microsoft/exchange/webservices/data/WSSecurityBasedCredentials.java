...
//kavi-start
    ...
    protected static final String wsAddressingHeadersFormat =
            "<wsa:Action soap:mustUnderstand='1'>http://schemas.microsoft" +
                    ".com/exchange/services/2006/messages/%s</wsa:Action>" +
    ...
    protected void emitExtraSoapHeaderNamespaceAliases(XMLStreamWriter writer) throws XMLStreamException {
        writer.writeAttribute("xmlns", EwsUtilities.WSSecuritySecExtNamespacePrefix, null,
                EwsUtilities.WSSecuritySecExtNamespace);
        writer.writeAttribute("xmlns", EwsUtilities.WSAddressingNamespacePrefix, null,
     ...
     * @throws XMLStreamException the xML stream exception
     */
    private void serializeWSAddressingHeaders(XMLStreamWriter xmlWriter, String webMethodName) throws
            XMLStreamException {
        EwsUtilities.EwsAssert(webMethodName != null, "WSSecurityBasedCredentials.SerializeWSAddressingHeaders",
                "Web method name cannot be null!");

        EwsUtilities.EwsAssert(this.ewsUrl != null, "WSSecurityBasedCredentials.SerializeWSAddressingHeaders",
                "EWS Url cannot be null!");

        // Format the WS-Addressing headers.
        String wsAddressingHeaders =
                String.format(WSSecurityBasedCredentials.wsAddressingHeadersFormat, webMethodName, this.ewsUrl);
    ...
    protected void serializeWSSecurityHeaders(XMLStreamWriter xmlWriter) throws XMLStreamException {
        EwsUtilities.EwsAssert(this.securityToken != null, "WSSecurityBasedCredentials.SerializeWSSecurityHeaders",
        ...
        String wsSecurityHeader =
                String.format(WSSecurityBasedCredentials.wsSecurityHeaderFormat, timestamp + this.securityToken);
