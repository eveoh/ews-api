...
interface ICustomXmlUpdateSerializer {
     ...
     */
    boolean writeSetUpdateToXml(EwsServiceXmlWriter writer, ServiceObject ewsObject,
                                PropertyDefinition propertyDefinition) throws XMLStreamException,
     ...
     * @throws Exception          the exception
     */
    boolean writeDeleteUpdateToXml(EwsServiceXmlWriter writer, ServiceObject ewsObject) throws XMLStreamException,
