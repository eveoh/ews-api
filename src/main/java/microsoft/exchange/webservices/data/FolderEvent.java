...
public class FolderEvent extends NotificationEvent {
    ...
    /**
     * The new number of unread messages. This is is only meaningful when EventType is equal to EventType.Modified.
     * For all
    ...
    /**
     * gets the Id of the folder that was moved or copied. OldFolderId is only meaningful when EventType is equal to
     * either
     * EventType.Moved or EventType.Copied. For all other event types, OldFolderId is null.
     *
     * @return oldFolderId
     */
    ...
    /**
     * Gets the new number of unread messages. This is is only meaningful when EventType is equal to EventType.Modified.
     * For all other event types, UnreadCount is null.
     *
     * @return unreadCount
     */
