 ...
 * <p/>
 * Necessary because the basic EwsServiceXmlReader does not use normalization (see E14:60369), and in order to turn
 * normalization off, it is necessary to use an XmlTextReader, which does not allow the ConformanceLevel.Auto that a
...
class EwsServiceMultiResponseXmlReader extends EwsServiceXmlReader {
     ...
     * @throws Exception
     */
    protected static EwsServiceMultiResponseXmlReader create(InputStream stream, ExchangeService service) throws
            Exception {
    ...
    private static XMLEventReader createXmlReader(InputStream stream) throws XMLStreamException {
        ...
        // E14:240522 The ProhibitDtd property is used to indicate whether XmlReader should process DTDs or not. By
        // default,
        // it will do so. EWS doesn't use DTD references so we want to turn this off. Also, the XmlResolver property is
        // set to an instance of XmlUrlResolver by default. We don't want XmlTextReader to try to resolve this DTD
        // reference
