...
public abstract class Attachment extends ComplexProperty {
     ...
     * Sets value of field.
     * <p/>
     * We override the base implementation. Attachments cannot be modified so any attempts the change a property on an
     * existing attachment is an error.
     *
    ...
    /**
     * Gets  the content Id of the attachment. ContentId can be used as a custom way to identify an attachment in
     * order to
     * reference it from within the body of the item the attachment belongs to.
     *
    ...
    /**
     * Gets  the content location of the attachment. ContentLocation can be used to associate an attachment with a Url
     * defining its location on the Web.
     *
    ...
    public Date getLastModifiedTime() throws ServiceVersionException {
        ...
        EwsUtilities.validatePropertyVersion(this.getOwner().getService(), ExchangeVersion.Exchange2010,
                "LastModifiedTime");
     ...
     * @throws Exception the exception
     */
    protected void internalLoad(BodyType bodyType, Iterable<PropertyDefinitionBase> additionalProperties) throws
            Exception {
