...
public class Task extends Item {
    ...
    /**
     * * Binds to an existing task and loads the specified set of properties. Calling this method results in a call to
     * EWS.
     *
     * @param service     the service
     * @param id          the id
    ...
    /**
     * * Deletes the current occurrence of a recurring task. After the current occurrence isdeleted, the task represents
     * the next occurrence. Developers should call Load to retrieve the new property values of the task. Calling this
     ...
     * EWS. Mutliple calls to EWS might be made if attachments have been added or removed.
     *
     * @param conflictResolutionMode the conflict resolution mode
     * @return A Task object representing the completed occurrence if the task is recurring and the update marks it as
     *         completed; or a Task object representing the current occurrence if the task is recurring and the uypdate
     *         changed its recurrence pattern; or null in every other case.
    ...
    public Task updateTask(ConflictResolutionMode conflictResolutionMode) throws ServiceResponseException, Exception {
        return (Task) this
                .internalUpdate(null /* parentFolder */, conflictResolutionMode, MessageDisposition.SaveOnly, null);
    }
    ...
    /**
     * Gets the recurrence pattern for this task. Available recurrence pattern classes include Recurrence.DailyPattern,
    ...
    /**
     * Gets a string representing the status of the task, localized according to the PreferredCulture property of the
     * ExchangeService object the task is bound to.
     *
