...
class TimeZonePropertyDefinition extends PropertyDefinition {
     ...
     */
    protected TimeZonePropertyDefinition(String xmlElementName, String uri, EnumSet<PropertyDefinitionFlags> flags,
    ...
    protected void writePropertyValueToXml(EwsServiceXmlWriter writer, PropertyBag propertyBag,
                                           boolean isUpdateOperation) throws ServiceLocalException, XMLStreamException,
