...
class SyncFolderItemsRequest extends MultiResponseServiceRequest<SyncFolderItemsResponse> {
    ...
    protected void validate() throws Exception {
        ...
        if (this.getService().getRequestedServerVersion().compareTo(ExchangeVersion.Exchange2010) < 0 &&
            ...
            throw new ServiceVersionException(
                    String.format(Strings.EnumValueIncompatibleWithRequestVersion, this.getSyncScope().toString(),
                            this.getSyncScope().name(), ExchangeVersion.Exchange2010));
        }
    ...
    protected void writeElementsToXml(EwsServiceXmlWriter writer) throws Exception {
        ...
        writer.writeElementValue(XmlNamespace.Messages, XmlElementNames.MaxChangesReturned,
                this.getMaxChangesReturned());
    ...
    /**
     * * Gets the maximum number of changes returned by SyncFolderItems. Values must be between 1 and 512. Default is
     * 100.
     *
