...
final class OutlookUser {
    ...
    /**
     * Converters to translate Outlook user settings. Each entry maps to a lambda expression used to get the matching
     * property from the OutlookUser instance.
     */
    private static LazyMember<Map<UserSettingName, IFunc<OutlookUser, String>>> converterDictionary =
    ...
    protected void convertToUserSettings(List<UserSettingName> requestedSettings, GetUserSettingsResponse response) {
        ...
        Map<UserSettingName, IFunc<OutlookUser, String>> converterQuery =
                new HashMap<UserSettingName, IFunc<OutlookUser, String>>();
