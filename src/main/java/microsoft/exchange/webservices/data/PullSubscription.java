...
public final class PullSubscription extends SubscriptionBase {
    ...
    /**
     * Obtains a collection of events that occurred on the subscribed folders since the point in time defined by the
     * Watermark property. When GetEvents succeeds, Watermark is updated.
     *
    ...
    /**
     * Begins an asynchronous request to obtain a collection of events that occurred on the subscribed folders since the
     * point in time defined by the Watermark property
     *
    ...
    /**
     * Ends an asynchronous request to obtain a collection of events that occurred on the subscribed folders since the
     * point in time defined by the Watermark property.When EndGetEvents succeeds, Watermark is updated.
     *
