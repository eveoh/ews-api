...
public final class ItemEvent extends NotificationEvent {
    ...
    /**
     * Id of the item that moved or copied. This is only meaningful when EventType is equal to either EventType.Moved or
     * EventType.Copied. For all other event types, it's null.
     */
    ...
    /**
     * Gets the Id of the item that was moved or copied. OldItemId is only meaningful when EventType is equal to either
     * EventType.Moved or EventType.Copied. For all other event types, OldItemId is null.
     *
