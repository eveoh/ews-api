...
class GetUserConfigurationRequest extends MultiResponseServiceRequest<GetUserConfigurationResponse> {
     ...
     */
    @Override
    protected GetUserConfigurationResponse createServiceResponse(ExchangeService service, int responseIndex) throws
            Exception {
    ...
    protected void writeElementsToXml(EwsServiceXmlWriter writer) throws Exception {
        ...
        writer.writeElementValue(XmlNamespace.Messages, XmlElementNames.UserConfigurationProperties,
