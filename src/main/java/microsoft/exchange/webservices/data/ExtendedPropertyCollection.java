...
public final class ExtendedPropertyCollection extends ComplexPropertyCollection<ExtendedProperty>
     ...
     */
    private boolean tryGetProperty(ExtendedPropertyDefinition propertyDefinition,
     ...
     */
    protected <T> boolean tryGetValue(Class<T> cls, ExtendedPropertyDefinition propertyDefinition,
     ...
     */
    @Override
    public boolean writeDeleteUpdateToXml(EwsServiceXmlWriter writer, ServiceObject ewsObject) throws
