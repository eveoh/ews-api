...
/**
 * This is a reimplementation of HTTPClient 3.x's org.apache.commons.httpclient.auth.NTLMScheme.<BR/> It will basically
 * use JCIFS (v1.3.15) in order to provide added support for NTLMv2 (instead of trying to create its own Type, 2 and 3
 * messages). <BR/> This class has to be registered manually with HTTPClient before setting NTCredentials:
 * AuthPolicy.registerAuthScheme(AuthPolicy.NTLM, JCIFS_NTLMScheme.class); <BR/> Will <B>not</B> work with HttpClient
...
public class EwsJCIFSNTLMScheme implements AuthScheme {
     ...
     * <p/>
     * <p> There are no valid parameters for NTLM authentication so this method always returns <tt>null</tt>. </p>
     *
    ...
    /**
     * The concept of an authentication realm is not supported by the NTLM authentication scheme. Always returns
     * <code>null</code>.
     *
    ...
    private class NTLM {
        ...
        /**
         * The character was used by 3.x's NTLM to encode the username and password. Apparently,
         * this is not needed in when
         * passing username, password from NTCredentials to the JCIFS library
         */
        ...
        private String generateType1Msg(String host, String domain) {
            jcifs.ntlmssp.Type1Message t1m =
                    new jcifs.ntlmssp.Type1Message(jcifs.ntlmssp.Type1Message.getDefaultFlags(), domain, host);
