...
public final class AttachmentsPropertyDefinition extends ComplexPropertyDefinition<AttachmentCollection> {
    ...
    private static final EnumSet<PropertyDefinitionFlags> Exchange2010SP2PropertyDefinitionFlags =
            EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead, PropertyDefinitionFlags.CanSet,
                    PropertyDefinitionFlags.ReuseInstance, PropertyDefinitionFlags.UpdateCollectionItems);

    public AttachmentsPropertyDefinition() {
        super(null, XmlElementNames.Attachments, "item:Attachments",
                EnumSet.of(PropertyDefinitionFlags.AutoInstantiateOnRead), ExchangeVersion.Exchange2007_SP1,
